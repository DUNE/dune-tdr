...
that the detector's lower \dword{gp} is lies over the cryogenic piping and that the tops of the \dword{dss} beams are submerged in \dword{lar} while leaving a \SI{4}-\SI{5}{\%} ullage at the top of the cryostat;
...
The feedthrough consists of a flange and $6 ^{''}$ \dword{od} structural tube welded to it that extends through the cryostat insulation.  
There is a
