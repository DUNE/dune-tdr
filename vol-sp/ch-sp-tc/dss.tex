...
\fixme{In table, one cable is 182 kg? Jim to check}
\begin{dunetable}
[DSS Loads]
{l|c|cc|cc}
...
detector. 
%The \dword{dss} defines the location of the detector inside the cryostat and also defines The 
\dword{dss} constrains the location of the detector inside the cryostat and also accommodates the detector elements' movement and contraction  %as the detector is brought to \dword{lar} temperature. 
during cooling. 
