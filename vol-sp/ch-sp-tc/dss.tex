...
\item Ensure that the detector's lower \dword{gp} is lies over the cryogenic piping and that the tops of the \dword{dss} beams are either fully submerged in \dword{lar} or fully in gas while leaving a \SI{4}-\SI{5}{\%} ullage at the top of the cryostat; 
