...
The  \coldbox{}es will be used to test the \dwords{apa} underground prior to installation inside the cryostat. The cryogenics supporting the \coldbox{}es  must ensure their reliable and safe operation. The  \coldbox cryogenics system must
\begin{itemize}
\setlength\itemsep{1mm}
\setlength{\parsep}{1mm}
\setlength{\itemsep}{-5mm}
\item support three \coldbox{}es testing dual \dwords{apa} operating in parallel: one in cool-down mode, two either in steady-state or warm-up modes.
