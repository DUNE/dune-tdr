...
of this \dword{tdr}) will establish a logistics organization for \dword{lbnf} and \dword{dune} to verify deliveries to the point of receipt in South Dakota and coordinate transport of materials from there  to the Ross Headframe.  \fixme{check TC vol ref- Anne} 
