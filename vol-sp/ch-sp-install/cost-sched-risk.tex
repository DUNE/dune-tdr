...
The costs for the %\dword{jpo} 
installation, integration and commissioning efforts are still being compiled. These costs will first be presented to the \dword{doe} in the second half of August  2019. After the data is submitted to the \dword{doe} the table in the \dword{tdr} will be updated.
