...
\includegraphics[width=0.95\textwidth]{graphics/dune_sp_fd.jpg}
\end{dunefigure}
...
\centering
\includegraphics[width=0.7\textwidth,trim=2mm 2mm 2mm 2mm,clip]{graphics/A2r} \\ \vspace{20pt}    %update image with red labels, trim border
\includegraphics[width=0.6\textwidth,trim=2mm 2mm 2mm 2mm,clip]{graphics/A3r}
\end{dunefigure}
...
\begin{minipage}{\textwidth}%{6in}
  \centering
 $\vcenter{\hbox{\includegraphics[width=0.25\textwidth]{graphics/Power_Supplies_300_and_200.jpg}}}$
 \hspace*{0.001\textwidth}  $\vcenter{\hbox{\includegraphics[width=0.7\textwidth]{graphics/ps_filter_ft_schematic}}}$
\end{minipage}
\end{dunefigure}
The requirement  
...
\begin{minipage}{\textwidth}%{6in}
  \centering
 $\vcenter{\hbox{\includegraphics[width=0.16\textwidth]{graphics/hv_feedthrough.png}}}$
 \hspace*{0.001\textwidth}  $\vcenter{\hbox{\includegraphics[width=0.82\textwidth]{graphics/francosHVFT}}}$
\end{minipage}
\end{dunefigure}
...
\includegraphics[width=0.6\textwidth]{graphics/donut_cpa2} %{ was Latest3D}
\end{dunefigure}
...
\includegraphics[width=0.7\textwidth]{graphics/cpa_panel-complete}
\end{dunefigure}
...
\includegraphics[width=0.95\textwidth]{graphics/field-shaping-strip-concept} %{ was Latest3D}
\end{dunefigure}
...
\includegraphics[width=0.8\textwidth]{graphics/profile-e-field.png}
\end{dunefigure}
...
\includegraphics[width=0.9\textwidth]{graphics/TBFC_FD_vs_PD.png}
\end{dunefigure}
...
\includegraphics[width=0.48\textwidth]{graphics/FC_mockup-1.png}
\includegraphics[width=0.48\textwidth]{graphics/FC_mockup-2.png}
\end{dunefigure}
...
\includegraphics[width=0.9\textwidth]{graphics/distortion_from_fc_gap}
\end{dunefigure}
...
\includegraphics[width=0.45\textwidth]{graphics/FC_with_GP}
%\includegraphics[width=0.33\textwidth]{graphics/tbfc2}
\end{dunefigure}
...
\includegraphics[width=0.8\textwidth]{graphics/EWFC_modules.png}
\end{dunefigure}
...
\begin{dunefigure}[ProtoDUNE-SP HV resistor divider board]{fig:ResDivBoa}
  ...
  \includegraphics[width=0.48\textwidth]{graphics/Divider_board.jpg}
  \includegraphics[width=0.48\textwidth]{graphics/ResDivBoa.png}
\end{dunefigure}
...
\includegraphics[width=0.9\textwidth]{graphics/e-field-distortion-due-to-open-resistor}
\end{dunefigure}
...
\begin{dunefigure}[HV interconnection topology]{fig:fdsp-hv-design-interconnect-concept}
  ...
  \includegraphics[width=0.7\textwidth]{graphics/fdsp-hv-interconnection-topology}
\end{dunefigure}
...
\includegraphics[width=0.8\textwidth]{graphics/protoDUNE-SP_TPCHV}
\end{dunefigure}
...
\includegraphics[width=\textwidth]{graphics/protoDUNE-SP_beamRunSum_HV}
\end{dunefigure}
...
\includegraphics[width=0.5\textwidth]{graphics/HV_autorecovery}
\end{dunefigure}
...
\includegraphics[width=0.75\textwidth]{graphics/PD_activity_on_streamers}
\end{dunefigure}
...
\includegraphics[width=0.5\textwidth]{graphics/12m-cpa}
\end{dunefigure}
...
\includegraphics[width=0.70\textwidth]{graphics/tbfc3}
\end{dunefigure}
...
\begin{dunefigure}[Endwall FC assembly table]{fig:endwall_assy_rot_table}{Assembly table with partially assembled \dword{ewfc} module. Box beams, cross beams, and slots for mounting of aluminum profiles are visible.}
 \includegraphics[width=0.8\textwidth]{graphics/endwall_assy_rot_table}
 \end{dunefigure}
...
%\includegraphics[width=0.48\textwidth]{graphics/fc_endwall_detail_side}
\includegraphics[width=0.7\textwidth]{graphics/3_fc_endwall_frames_hanging}
\end{dunefigure}
...
\includegraphics[width=0.9\textwidth]{graphics/ReflectorOnCPA.png}
\end{dunefigure}
...
\includegraphics[width=0.7\textwidth]{graphics/SBND_Laser_Arrangement.png}
\end{dunefigure}
