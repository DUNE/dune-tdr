...
\dword{topfc} module with a \SI{30}{\cm} clearance.  This distance represents a 50\% increase over the value used in \dword{pdsp}, to further reduce the maximum \efield in the TPC. 
...
The redundancy in electrical connections described above meets requirement (6). %TOP Level requirement 6? 2? 5? SP-FD, SP-HV?
...
The scale of DUNE will make dedicated \dword{qc} tools essential.
