...
%Anne testing \endwall


This \dword{dune} detector installation chapter covers all the work and infrastructure needed in South Dakota to install the single-phase detector. 
...
Here the work performed in the \dword{itf} is described, the \dword{itf} infrastructure requirements are presented and the tests performed during the integration process are explained. 
