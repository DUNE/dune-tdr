...
\dword{tdr} (Volume 2 Chapter 5). The event classification is based
...
still under development. Further developments of \dwords{asic} for the
\dword{dune} \dword{spmod} are discussed later in Section~\ref{sec:fdsp-tpcelec-design-femb}.
...
%\includegraphics[width=1.0\linewidth]{sp-tpcelec-pdsp-noisespectrum.png}
