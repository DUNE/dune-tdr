...
the \dword{adc} bits. These channels can be masked from analysis,
resulting in a loss of efficiency for \dword{pdsp} and plans have
...
Problems have alsy been observed in \dword{larasic}.

No COLDATA

During the assembly problem with FEMB cables

Residual noise in ProtoDUNE
