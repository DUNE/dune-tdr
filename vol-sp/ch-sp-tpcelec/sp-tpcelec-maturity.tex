...
to previous \dword{lar} detectors.
...
done for past \dword{lar} detectors, starting with \microboone and
...
designs from the \dword{slac} group, and the implementation of the FE amplifier
