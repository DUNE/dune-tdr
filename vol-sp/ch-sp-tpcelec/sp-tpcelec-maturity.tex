...
of coherent noise observed in \dword{pdsp} has been significantly
...
in one of its versions, for \dword{microphone} and for \dword{pdsp} reaching the 
...
\dword{asic}s the \dword{coldadc} and \dword{coldata}.
