...
\dword{tpc} electronics detector components, further processing this data to
...
This includes both database needs (for storing detector calibration constrants
