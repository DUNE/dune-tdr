...
References to documents in DocDB need to be fixed. Most probably the CISC
in the table will appear as CISC once the volume is complete.}
...
and transmits it through two 10~Gbit/s links to the \dword{daq} back-end.
