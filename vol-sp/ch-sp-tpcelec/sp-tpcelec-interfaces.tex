...
{tab:CEinterfaces}
{\dword{tpc} electronics system interface links. }
...
multi-mode fibers, compatible with either the \dword{om3} or \dword{om4} standards. Individual
...
of the cryostat penetration will be responsibility of the \dword{tpc} electronics
consortium.
...
the \dword{dune} simulation and reconstruction software. These include the
simulation of the material of the detector components, and the simulation
...
response to be used in the event reconstruction software. Many of these
...
updated to reflect the updates to the detector. Similarly the \dword{tpc}
...
data. The calibration data are also relevant to the calibration consortium,
