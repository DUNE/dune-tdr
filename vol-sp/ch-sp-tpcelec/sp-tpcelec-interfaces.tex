...
with the itf. 4/26 Anne replaced with `installation team' - please check!}

\begin{dunetable}
[CE system interfaces]
{p{0.25\textwidth}p{0.5\textwidth}l}
{tab:CEinterfaces}
{\dword{ce} system interface links. }
...
\\ \colhline
Installation Team %\dword{itf} 
& Material handling and testing activities of  the \dword{tpc} electronics 
consortium, %at the \dword{itf}, 
\coldbox for \dword{apa} tests& \cite{bib:docdb7027}
\\ \colhline
