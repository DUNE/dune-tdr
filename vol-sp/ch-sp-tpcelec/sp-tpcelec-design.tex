...
the \dword{larasic} signals) from being input correctly to the sample-and-hold amplifiers. To overcome this
problem we have operated \dword{coldadc} with the digital voltage set at \SI{2.1}{V}, at which point the
