...
\SI{1.5}{V} (matching the output range of \dword{larasic}, \SIrange{0.2}{1,4}{V})
...
a usable dynamic range of $\sim\num{3200}$ \dword{adc} counts. From these
distribution the values for the \dword{sinad} of \SI{65.75}{dB} and for
