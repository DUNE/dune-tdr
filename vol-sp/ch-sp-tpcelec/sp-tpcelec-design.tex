...
\fixme{I'd ditch this next text}
...
\includegraphics[width=0.9\linewidth]{sp-tpcelec-cr-board.pdf}
\end{dunefigure}
...
correct. Bench tests of \dword{coldata} will be completed before the end
...
\dword{tpc} for system integration tests in fall 2019. The main drawback of
...
will be used for the \dword{sbnd} experiment. \fixme{still true? Check dates throughout pgraph}
...
the two kinds of \dwords{asic} will be available in fall 2019 
...
on the \dword{asic} selection in fall 2019,  \fixme{did it happen?} at least one year
...
\includegraphics[width=0.85\linewidth]{sp-tpcelec-PSNR.pdf}
\end{dunefigure}
...
second induction plane it is 19 (21). \fixme{not clear what the two sets of numbers refer to}
...
\includegraphics[width=0.7\linewidth]{sp-tpcelec-UplaneNoiseFFT.pdf}
\end{dunefigure}
...
and further validation is planned for fall 2019. \fixme{update?} We consider this solution as
