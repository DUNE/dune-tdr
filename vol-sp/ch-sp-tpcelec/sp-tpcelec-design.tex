...
that \dword{lvds} signals can easily be driven over \SI{22}{m} or greater
...
a factor three for operation in \dword{lar}. For each \dword{apa}, the total power 
...
the cross section of the side tubes from $\num{7.62}\times\SI{7.62}{cm^2}$
to $\num{10.16}\times\SI{10.16}{cm^2}$, routing was difficult. After understanding that we
...
a \SI{6.35}{cm} diameter conduit was inserted inside the
...
models for the \SI{180}{nm} \dword{cmos} technologoy for operation in \lar, such that the saturation effect observed in 
...
\fixme{this next paragraph and bulleted list need to be updated.}
...
They are undergoing standalone tests
