...
and after applying a simple offline common-mode filter and partially mitigating \dword{adc} issues~\cite{pend_PDSP_PerfPaper}.}
%\includegraphics[width=0.49\linewidth]{sp-tpcelec-avgFFT-WithoutFilt.pdf}
%\includegraphics[width=0.49\linewidth]{sp-tpcelec-avgFFT-WithFilt.pdf}
...
It should be noted that even if the reference for \dword{spmod} foresees the usage
...
\dword{asic}, the \dword{i2c} interface required to program and readout
