...
\fixme{Consider revising grounding section, which is copied directly from IDR}
...
\fixme{Consider revising bias voltage section, which is copied directly from IDR (except for updated CR board figure)}
