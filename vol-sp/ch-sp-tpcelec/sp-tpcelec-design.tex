...
{fig:pipelinestage}
{Circuit blocks in each \dword{adc} pipeline stage. MUX is a circuit that controls
...
a factor of three for operation in \dword{lar}. For each \dword{apa}, the total power 
