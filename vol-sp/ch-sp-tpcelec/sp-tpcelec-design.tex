...
\fixme{Figure 4.11 will be replaced with a new one to be provided by Cheng-Ju Lin.}
...
of one channel of \dword{coldadc}. The measured histogram of \dword{adc} codes was fitted to the 
...
\fixme{ Figures 4.30 and 4.31 are still the old ProtoDUNE ones. We are working on replacement ones.}
\begin{dunefigure}
