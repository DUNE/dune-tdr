...
\item{The warm interface is different. Only a single clock is needed (\SI{56}{MHz}), and the configuration protocol is the \dword{slac} \dword{asic} control interface (SACI)~\cite{SACI} rather than I2C.} \fixme{SACI is not in the glossary.}
\end{itemize}
