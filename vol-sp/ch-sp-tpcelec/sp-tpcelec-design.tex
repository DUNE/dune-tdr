...
in terms of power and of at least two in terms of power
...
distribution of \dword{snr} is 38 (49), for the first induction plane it is 16 (18), and for the
...
{Spectrum of the noise on the first induction plane of the \dword{pdsp} \dword{apa}s before
 and after applying a simple common-mode filter and partially mitigating \dword{adc} issues~\cite{pend_PDSP_PerfPaper}.}
%\includegraphics[width=0.49\linewidth]{sp-tpcelec-avgFFT-WithoutFilt.pdf}
%\includegraphics[width=0.49\linewidth]{sp-tpcelec-avgFFT-WithFilt.pdf}
