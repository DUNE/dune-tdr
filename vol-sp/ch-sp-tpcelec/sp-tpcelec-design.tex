...
which will implement a single-ended to differential converter for 
...
line of the \dword{lv} converters using a single line, most probably
...
provides real-time monioring of the \dword{wib} status to the slow control system.
