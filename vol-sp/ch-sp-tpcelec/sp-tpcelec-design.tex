...
the \dword{fe} amplifier noise, and from other aspects of the system, e.g., the  channeling of noise inside
the cryostat through ground connections and through the readout
chain of other detector components, like the \dword{pds}, the \dword{hvs},
...
\fixme{A smart reader may notice that the values of the resistances
and capacitors in the APA and CE chapters are not identical and
the drawing does not match them. Neither Alberto Marchionni nor
Marco Verzocchi have managed to get the official numbers from the
APA consortium despite the fact that we have been asking them for
one week.}
...
in \dword{sar} architecture were identified with 100\% cold yield. Starting in
