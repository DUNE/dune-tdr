...
sections, and the picture here is also inconsistent. This will
be fixed before releasing the TDR to the LBNC.}

\fixme{APA: resistors are 50 MOhm for the wires, 2 MOhm for
the bias, capacitors are 3.9 nF for the wires, 39 nF for the
bias. The bill of material for the CR boards does not give the
same values. CE: 50 MOhm for the wires, 2.2 MOhm for the
bias, capacitors are 4.7 nF for the wires, 47 nF for the bias.
The figure has 47 nF written as 50 nF. To say the least there
is some confusion.}
...
A schematic diagram of the \dword{pdsp} \dword{apa} wire bias 
