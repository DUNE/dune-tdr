...
\fixme{The material contained in this section could be moved entirely 
...
The current plan for the \dword{ce} consortium is to receive all detector 
...
\dword{qc} sites. The \dwords{femb} are then installed the \dwords{femb} 
on the \dword{apa}s, followed by a second check of the functionality of 
...
\fixme{This Section should contain a summary of the calibrations performed 
...
before tracks from cosmics can be observed in the detector. It would
be important to discuss here also what we have learned from ProtoDUNE
about the internal calibrations, how frequently do they need to be done,
how much do they drift.}
...
\dword{apa}s APAs even while the corresponding wires are in 
the gaseous argon.
