...
of chips per wafer is 390 for \dword{larasic}, 928 for \dword{coldadc}, 
232 for \dword{coldata}, and 220 in the case of \dword{cryo}. 
These numbers are based on the assumption that \dword{coldadc}
and \dword{coldata} are fabricated on the same wafer.
...
used for installation on the \dwords{femb}, we assume that 10\% of 
the chips will fail during the \dword{qc}
...
reduced if wafers are purchased for two \dword{sp} detectors at a time. 
