...
\begin{dunetable}
[TPC electronics consortium intitutions ]
{ll}
...
\includegraphics[width=\linewidth]{graphics/sp-tpcelec-orgchart.pdf}
\end{dunefigure}
...
The first version of all \dwords{asic} underwent
...
\includegraphics[width=0.8\linewidth]{graphics/sp-tpcelec-responsibilities.pdf}
\end{dunefigure}
...
\begin{dunetable}
[TPC electronics consortium schedule]
...
Complete system and lifetime tests on the first generation of \dwords{asic} and \dwords{femb} & May 2020\\ \colhline
Submission of second generation of \dwords{asic} & June 2020 \\ \colhline
...
\includegraphics[width=\linewidth]{graphics/sp-tpcelec-schedule.pdf}
\end{dunefigure}
