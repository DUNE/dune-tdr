...
the \dword{apa}s to power, control, and readout. 
...
\includegraphics[width=0.8\linewidth]{sp-tpcelec-responsibilities.png}
\end{dunefigure}
...
Begin integration of the \dwords{femb} on the \dword{apa}s at \dword{surf} & Aug 2024 \\ \colhline
Complete integration of the \dwords{femb} on the \dword{apa}s at \dword{surf} &  Mar 2025\\ \colhline
...
\dword{surf} is displayed graphically in Figure~\ref{fig:sp-tpcelec-schedule}.

\fixme{A better figure 4.50 will be done if time allows.}
