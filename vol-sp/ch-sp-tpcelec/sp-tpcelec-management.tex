...
\fixme{May want to remove "including an estimate of the resources required"
if the cost discussion is removed from the TDR.}
...
\fixme{Cut here if removing the cost discussion ?}
