...
\dword{pdsp} is designed as a full slice of the \dword{dune} \dword{fd} \dword{spmod}  
...
next iteration of the system design for the \dword{fd} \dword{spmod}, as discussed in 
...
new \dwords{asic} designs). Tests will be performed in 
...
has been built using the same wire boards and anchoring elements identical to
...
of the cold box at \dword{cermn} and of tests performed in \dword{pdsp}
