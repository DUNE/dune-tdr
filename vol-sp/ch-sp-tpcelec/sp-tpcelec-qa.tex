...
stringent requirements like small number of failures ($<$ 1\% of the total number of
...
use \dword{cmos} electronics, the aspect of these results that is most relevant for \dword{dune} 
