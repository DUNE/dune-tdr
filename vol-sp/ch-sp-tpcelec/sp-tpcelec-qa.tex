...
1/10$^{\mathrm{th}}$ of a \dword{dune} \dword{apa}. The \dword{apa} mechanics are designed to accommodate 
...
of the tests performed at \dword{iceberg} is that the performance of the
...
\begin{itemize}
	...
	circuit boards populated with resistors and diodes inside the cryostat. This
        ...
        and summing boardsThe ATLAS \dword{lar} Hadronic Endcap 
...
\begin{itemize}
	...
	operating at \dword{lar} temperature.
        ...
        methodology used in the semiconductor industry, will be used to verify the expected
