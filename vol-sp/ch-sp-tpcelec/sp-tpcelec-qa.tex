...
these issues, \dword{fermilab} has built a new cryostat (\dword{iceberg}) that will be used for 
...
\dword{tpc} with dimensions \SI{125}{cm}~$\times$~\SI{125}{cm}~$\times$~\SI{60}{cm}. For
