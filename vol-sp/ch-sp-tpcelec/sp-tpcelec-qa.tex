...
were deployed at \dword{bnl} for \dword{pdsp} production, \dword{femb} QC, and SBND \dword{asic} QC.
...
\dwords{femb} and the \dword{apa} wires uses the same \dword{cr} boards used 
