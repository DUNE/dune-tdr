...
\input{generated/risks-longtable-SP-FD-TPC} % need to fix name of it to reflect CE
...
(RT-SP-TPC009 in Table~\ref{tab:SPCE:risks}) is excessive noise 
...
installed inside (RT-SP-TPC-011 in Table~\ref{tab:SPCE:risks}) and on top (RT-SP-TPC-011)
