...
\fixme{Add a column in the risk table to indicate the importance of every risk}
...
7 & Excessive noise observed during detector commissioning & Medium \\ \colhline
8 & Lifetime of components in the \dword{lar} & Medium \\ \colhline
9 & Lifetime of components on the top of the cryostat & Low \\ \colhline
\end{dunetable}
...
fabrication or during the \dword{qc} process; downtime at one of the \dword{qc} sites; or losses during 
...
physics analyses. Further studies are planned for 2019, after the end of the \dword{pdsp}
