...
part of this \dword{tdr} (Volume~\volnumbertc, Chapter 10). 
...
part of this \dword{tdr} (Volume~\volnumbertc, Chapter 6). %Commented out because it breaks the automatic build system %(\refch{tc}{vl:tc-facility})
...
of the \dword{apa}s in the cold boxes at \dword{cern}, \dword{fermilab},
