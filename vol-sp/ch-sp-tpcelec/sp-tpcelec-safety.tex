...
of the project. The members of \dword{tpc} electronics consortium will
...
and \dword{surf}, will be part of the 
...
in the \dwords{wiec} and the \dword{tpc} electronics racks, break down 
...
\dword{tpc} electronics supplies. Appropriate filters will be added to the
air supply used to cool the \dwords{wiec} and the \dword{tpc} electronics power and bias voltage supplies, thus minimizing
