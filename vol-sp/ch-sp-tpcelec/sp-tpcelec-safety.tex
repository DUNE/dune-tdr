...
\fixme{Again, a brief overview of the section could be included to help the logical flow of the document.}
...
\dword{sp} far detector is crucial for the success
...
\fixme{The previous segment could easily serve as an introduction to section 1.7 if the text is moved.}
...
and the level of personal protective equipment (PPE) \fixme{Should this abbreviation go in the glossary?} will be determined
...
at \dword{fermilab} for handling the \fixme{Should these abbreviations go in the glossary?} CCDs of the DES experiment (the 
...
the LN \fixme{Is LN correct here?} at the end of a test. For the cold cables, this 
...
off transmitters on the \dwords{wiec} if the readout fiber 
