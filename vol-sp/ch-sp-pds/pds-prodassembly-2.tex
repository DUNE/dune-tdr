...
\fixme{For Dave --- not explained well; which one shrinks? -Anne}
...
\fixme{Section will remain but requires new calculations based on X-ARAPUCA design.  Will be complete by January 2019 revision. -Dave}
