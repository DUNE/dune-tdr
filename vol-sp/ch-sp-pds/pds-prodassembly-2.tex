...
\item \dword{apa} support rails and electrical connectors:  Stainless steel rails and associated hardware for supporting the \dword{pd} modules inside the \dword{apa} will be fabricated by vendor in the \dword{us}.  Components for cable connection between the upper and lower \dword{apa}s, and cable management pieces, will be procured from vendors, assembled, and tested in the USA.  
