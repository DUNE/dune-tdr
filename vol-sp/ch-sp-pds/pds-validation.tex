...
\begin{itemize}
    ...
    \item \dword{sbnd} will provide a multi-year test of many X-ARAPUCA components, such as coated filter plates, \dword{wls} plates, and photosensors.  \dword{sbnd} will run for at least three years, starting in late 2020.  As part of a running experiment, the system will be continuously monitored for gain and response of the detectors and will provide information regarding aging of \frfour G-10 structures, photosensors, and coated filter plates as well as \dword{wls} plates to be used in the \dword{xarapu} modules.
