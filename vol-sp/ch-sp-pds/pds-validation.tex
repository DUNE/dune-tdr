...
\begin{dunefigure}[Dark count rate for FBK NUV-HD-SF \dwords{sipm}.]
 {fig:fbk-dcr}
...
\begin{dunefigure}[PDS response to \SI{7}{GeV/c} momentum electrons and muons in \dword{pdsp}.]{fig:protodune-allmodules-7gev}
...
\begin{dunefigure}[Detected photons in \dword{sarapu} for several beam  momenta.]{fig:arapuca_beamph}
