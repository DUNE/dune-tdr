...
Packaging plans are informed by the \dword{pdsp} experience.  Each \dword{sp} module will be individually sealed into a light-tight antistatic plastic bag.  Bagged modules will be packaged in groups of ten modules (matching the need for a single \dword{apa} into a single shipping box, approximately \SI{20}{cm} $\times$ \SI{20}{cm} $\times$ \SI{250}{cm} long.  These shipping boxes will be gathered into larger crates to facilitate shipping.  The optimal number per shipping is being considered.
