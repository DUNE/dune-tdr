...
Details of \dword{pd} integration into the \dword{apa} and installation into the cryostat, including quality management testing equipment, tests and documentation are included in the Single-Phase Technical Coordination chapter (Chapter~\ref{}).

\fixme{Anne:  We need to reference the Single-Phase Technical Coordination chapter here.  Not sure how to do that:  Can you help?}

%\fixme{Anne/Dave: Needs a reference to the chapter.}
...
%\fixme{Dave: Is this issues settled and we can remove the previous fixme?}
