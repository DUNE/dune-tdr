...
The baseline design, the \dword{xarapu} detailed in Section~\ref{ssec:fdsp-pd-pc-arapuca}, is an evolution of the ARAPUCA concept that combines the light trapping capability of \dword{sarapu} with the collection and transport capabilities of light guides, which DUNE also evaluated.  
