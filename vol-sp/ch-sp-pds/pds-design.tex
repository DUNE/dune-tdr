...
The final requirements for the system will be informed by analysis of the data from the readout system implemented in \dword{pdsp} and subsequent data from \dword{iceberg}  expected in summer 2019. \fixme{this is now past. Anne}
