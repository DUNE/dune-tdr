...
2 & Timing performance of the PD electronics/SiPM/cabling  does not meet the \SI{1}{\micro\second} time resolution specification \\ \colhline
...
4 & Cabling for PD and CE cannot be accommodated within the \dshort{apa} frame or during the 2-APA assembly/installation procedure. \\ \colhline
5 & Experience with validation prototypes shows that the mechanical design of the PD is not adequate. \\ \colhline
6 & \dshort{ptb} WLS filter coating not sufficiently stable, contaminates \dshort{lar}. \\ \colhline
...
9 & Previously undetected electromechanical interference discovered during integration\\ \colhline
