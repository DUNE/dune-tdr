...
% Fixed--  DWW.
%\fixme{DAVE: Section 1.9.1.2
%Page 53, line 24: “approximately 18 months for all 48,000 filter plates required.” It seems to refer to the filter plates not WLS. Maybe this belongs to the previous section? Or is the time scale correct and should just change the 48,000 filter plates for the 6,000 WLS plates in the text?
%
%In the previous section no timescale is given for the complete production of the filter plates.
%}
