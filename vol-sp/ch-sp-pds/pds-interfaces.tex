...
\begin{itemize}
    ...
    \item Developing a common cable routing plan allowing the systems to share a common cable tray system on top of the \dword{apa} frame and routing the cables to the cryostat flanges
...
The primary interactions between the \dword{pd} and the CSCI include:
...
These interface documents cover the interface of the \dword{pd} group with the technical coordination groups.  They are covered in great detail in the Integration and installation chapter of the TDR (see Chapter~\ref{ch:fdsp-hv}).

\fixme{Add correct link to integration and installation chapter}
