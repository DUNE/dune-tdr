...
The scope of the \dword{pd} TDR section ends with delivery of the modules to the \dword{itf} Interface documents with the project Interface and Installation working group cover the interface of the \dword{pd} group with the technical coordination groups who oversee the integration of the \dword{pd} modules and electronics into the \dword{apa} and \dword{daq}.  
...
The \dword{pd} consortium retains responsibility for providing quality management tooling and test plans at the \dword{itf}, as well as specialized labor and supervisory personnel for \dword{pd} module integration and installation. Distribution of these responsibilities are covered in the Integration \dword{pd} consortium interface document.
