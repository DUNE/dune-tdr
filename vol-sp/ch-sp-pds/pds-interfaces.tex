...
%\fixme{DWW:  this is my stab at capturing the physics impact of light leaks etc.  Ernesto, Yasar, please see if it looks at all satisfactors and edit as needed.\\
%EK: added an extra comment on the need to quantify the impacts of light leakage on physics. I didn't add any comment regarding the requirement based purely on data transfer rate caused by light contamination.}
