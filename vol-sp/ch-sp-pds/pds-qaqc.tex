...
The \dword{pds} consortium will perform the design and fabrication of the components in accordance with the applicable requirements of the \dword{lbnf-dune} \dword{qa} plan. If the institute (working under the supervision of the consortium) performing the work has a documented \dword{qa} program, the work may be performed in accordance with their own program.
