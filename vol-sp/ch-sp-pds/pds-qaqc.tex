...
%(Add pictures?)
\item mechanical interface testing, beginning with simple mechanical go-nogo gauge tests, followed by installation into the \dword{pdsp2} system, and finally full-scale interface testing of the \dword{pds} into the final pre-production TPC system models; and
