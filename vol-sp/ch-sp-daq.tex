...
Subsequently, Section~\ref{sec:fd-daq:design} comprises the bulk of this chapter and
describes the design of the \dword{fd} \dword{daq}.
Section~\ref{sec:fd-daq:protodune} describes the 
\dword{protodune} system which has served as a demonstrator of several
key aspects of the design, and serves as a platform for further design
development. 
...
DUNE has three main physics drivers: neutrino \dword{cpv} and related
