...
\dword{dune} top-level as well as \dword{daq}-level requirements. These
are summarized in Table~\ref{tab:specs:SP-DAQ}.
The system is designed to meet these requirements and does so by
following key specifications provided in Table~\ref{tab:specs:SP-DAQ}
