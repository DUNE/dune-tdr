...
to the readout of the entire detector module for a period equal to \SI{5.4}{\milli\second}.  Extended triggers (\dword{snb}) will
...
\fixme{Add text on co-processor development. This is coming Monday
  from Dave and Jim. Georgia}
