...
\begin{dunefigure}{fig:daq-conceptual-overview}{\dword{daq} Design Overview}
...
sensing time scales.
Ionization charge measurement by the \dword{tpc} of any ionizing particle requires a
...
\dword{lartpc} experiments like ICARUS, \microboone, and
