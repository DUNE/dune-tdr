...
\begin{dunefigure}[Expected physics-related activity
    ...
    rates in a single \nominalmodsize module. \label{sec:daq:rates}
}
...
Table~\ref{tab:daq:parameters} summarizes the important parameters driving the \dword{daq} design. These parameters set the scale of data buffering, processing, and transferring resources that must be built into each \dword{fd} module. 
