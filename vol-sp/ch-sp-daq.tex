...
\item a \dword{ptp} signal providing an absolute time for each \dword{pps}, and
...
\item Use of vertical slice teststands for further development and testing of
  ...
  overall \dword{daq}
\item Use of horizontal slice tests to demonstrate scalability of the design
...
\item Engagement with  developments and measurements in other ongoing
