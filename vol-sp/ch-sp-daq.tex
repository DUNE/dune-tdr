...
\begin{dunefigure}{fig:daq-tc-eff}{Efficiency for forming trigger candidates as input trigger primitives from two algorithms, online (blue) and offline (red).}
  \includegraphics[width=0.7\textwidth]{Electron_Efficiency_Comparison.pdf}
\end{dunefigure}

\fixme{TC efficiency figure is a place holder until we get it remade as a better looking PDF.}
