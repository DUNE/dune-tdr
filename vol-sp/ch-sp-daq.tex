...
\begin{dunefigure}[DAQ conceptual design overview for one
  module]{fig:fd-daq:layout}{\dword{daq} conceptual data flow focusing
    on a single \nominalmodsize module. Included are the upstream
    \dword{daq} in orange, \dword{daqdsn} in blue, \dword{daqbes}
...
Figure~\ref{fig:daq:data-selection-hierarchy} and details may be found
in~\citedocdb{11215}. 
...
extended SNB trigger, and each prompts the corresponding readout of an event record. 
...
Section~\ref{sec:daq:design-upstrea}) and subsequent
