...
individual modules are serviced essentially independently and only loosely
...
several key aspects of the  \dword{dune}  \dword{daq}  design, and continues
to serve as a platform for further design development and validation toward
the DUNE \dword{daq} design.  Finally, the chapter finishes with two sections
