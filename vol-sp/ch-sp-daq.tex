...
specifications provided in Table~\ref{tab:fd-daq:specifications}. Some of those
specifications are derived from the overall \dword{dune} \dword{fd} \dword{daq}
top level requirements, as indicated in the table.
...
overwriteexisting data in the solid-state-drives. & \\ \colhline
