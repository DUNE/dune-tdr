...
\begin{dunefigure}{fig:daq:data-selection-hierarchy}{Data Selection
  ...
  \includegraphics[width=0.8\textwidth]{DS_hierarchy.png}
\end{dunefigure}
...
\begin{dunefigure}{fig:daq:data-selection}{Block diagram of \dword{dune} \dword{daq}
  ...
  \includegraphics[width=0.8\textwidth]{DS_summary.png}
\end{dunefigure}
...
Columbia & USA     \\ \colhline
UC Davis & USA     \\ \colhline
Duke & USA     \\ \colhline
UC Irvine & USA     \\ \colhline
FNAL & USA     \\ \colhline
Iowa State & USA     \\ \colhline
