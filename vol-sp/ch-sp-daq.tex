...
Expected data rates from physics signals of interest, which fit the
requirement of \offsitepbpy sent to permanent storage, are summarized in Table~\ref{tab:sp-daq:rates} and detailed in~\citedocdb{9240} and potential bottlenecks were analyzed in~\citedocdb{11461}.
