...
Figure~\ref{fig:daq-conceptual-overview}, while Figure~{fig:daq-design}
...
subsystem. The back-end DAQ subsystem is hosted in O(10) servers and
facilitates event building and buffering for built
