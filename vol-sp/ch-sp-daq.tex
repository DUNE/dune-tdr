...
=======
requirements 
listed in Table~%\ref{tab:fd-daq:requirements}. 
The system is
designed to meet these requirements and does so by following key
specifications provided in Section~\ref{sec:fd-daq:specifications}. 

\fixme{Add requirements table. (Anne - commenting out refs to it.}
%\input{generated/req-sp-daq.tex} 
>>>>>>> 732e169a0b1c7e1e73e510ec68fa9a53c0cd97dc
...
by the \dword{dune} physics mission, and with high efficiency. 
...
To ensure the requirements in Table %~\ref{tab:fd-daq:requirements} 
are
