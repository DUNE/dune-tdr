...
integration window yields high ($>90$\%) galactic coverage\footnote{Galactic coverage is defined as
supernova burst trigger efficiency, weighted by the probability of a galactic \dword{snb} (which
is \dword{snb} distance-dependent).} while
...
applied to further increase efficiency and minimize background \cite{bib:docdb14522}.
