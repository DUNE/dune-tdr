...
Fig.~\ref{xx}. \fixme{GK: describe here the main two hardware platforms,
  neither of which is exactly the baseline for the TDR, but how the
  baseline combines elements of the two. Then, differences.}.
...
during operations. This is currently in development \citedocdb{}.
