...
\begin{dunefigure}[DAQ schedule for first \SI{10}{\kilo\tonne} module]{fig:daq-schedule}{\dword{daq} schedule for first \SI{10}{\kilo\tonne} module. \label{sec:fd-daq:schedule}}
...
The consortium will strictly follow ES\&H guidelines for the project with
respect to production, installation, and commissioning of the system.

A set of risks have been identified by the consortium, and are listed,
together with mitigation strategies and risk level post-mitigation, 
in Table~\ref{tab:risks:SP-FD-DAQ}. Risk is quantified with respect to
...
\fixme{Post-mitigation risks are still H? Need some discussion of risks}
