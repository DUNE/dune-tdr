...
Trigger primitive performance is summarized in
...
This measure is used downstream by the module level trigger, 
...
Trigger candidate performance is summarized in
Section~\ref{sec:sp-daq:design-validation}.
