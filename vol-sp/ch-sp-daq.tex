...
\begin{itemize}
  \item Each readout segment is then received by an available \dword{eb} process for execution. Execution entails interpreting the \dword{trigcommand} segment and querying the appropriate upstream \dword{daq} units to request data from the period of time. 
