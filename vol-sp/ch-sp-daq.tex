...
summarized in Table~\ref{tab:spec:SP-DAQ}. The \dword{daq}-level requirements are
...
\fixme{The table should have a different title: Maybe Requirements and
  Specifications Relevant to the DUNE FD DAQ System. Georgia}
