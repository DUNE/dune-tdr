...
The configuration system will mainly consist of standard configuration management components, with a high emphasis on the audit system, in order to verify that the global configuration of the DAQ complies with the detector, physics and operational requirements.
