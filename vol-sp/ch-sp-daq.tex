...
\begin{dunefigure}{fig:fd-daq:layout}{\dword{daq} design physical
  ...
  \includegraphics[width=0.8\textwidth]{daq-layout-2.pdf}
\end{dunefigure}
...
\begin{dunefigure}{fig:daq-rates}{Expected physics-related activity
  ...
  \includegraphics[width=0.8\textwidth,clip,trim=6cm 6cm 10cm 2cm]{daq-event-type-rates-vs-energy.pdf}
\end{dunefigure}
...
\subsection{Timing and Synchronization Subystem}
...
implementation which has been the subject of successful demonstration
...
however is a possibility within the upstream DAQ design, and offers an
