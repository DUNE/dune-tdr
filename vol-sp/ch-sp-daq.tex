...
\begin{dunefigure}{fig:fd-daq:layout}{\dword{daq} design physical
  ...
  \includegraphics[width=0.8\textwidth,trim=5cm 4cm 5cm 4cm]{daq-layout-2.pdf}
\end{dunefigure}
...
\begin{dunefigure}{fig:daq-conceptual-overview}{\dword{daq} Conceptual
  ...
  \includegraphics[width=0.95\textwidth]{daq-toplevel-conceptual-nebot.pdf}
\end{dunefigure}
...
high level filter. Each trigger level is described in subsequent
...
\begin{dunefigure}{fig:daq:data-selection}{Block diagram of \dword{dune} \dword{daq}
  ...
  \includegraphics[width=0.95\textwidth]{DS_summary_2.pdf}
\end{dunefigure}
...
Viable algorithms for the low level trigger already exist, as do
algorithms for a module level supernova burst trigger, and it has
been demonstrated offline that the efficiency for SNBs meets the DUNE
requirements \cite{xx}. On the other hand, the pipelines of processing required
for \dword{daqdsn} may execute in various stages and forms using different firmware and software
...
to the readout of the entire detector module for a period equal to 5.4\si{\milli\second}.  Extended activity triggers (\dword{snb}) will
