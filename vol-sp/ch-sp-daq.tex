...
and operations considerations, and are motivated in the following subsections.
...
\subsubsection{Design Practicalities}
...
built into the design of each \dword{fd} module. %\fixme{This sentence simply repeats the table title. A little more discussion of the trends revealed in the table would help here, but obviously, that must wait for the values.}
