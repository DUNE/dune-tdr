...
% \fixme{This whole section could use a bit more editing; but no time. Anne}  %%% I've done what I could. Glenn
...
%\fixme{check my edits above. anne } %%% Looked ok to me, no time to check more carefully. - Glenn
...
% \fixme{I'd remove `serious'. Anne} %%% Agreed =Glenn
