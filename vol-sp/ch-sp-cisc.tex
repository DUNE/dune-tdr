...
\begin{dunefigure}[\dword{cisc} subsystem chart]{fig:cisc-subsystem-chart}
  ...
  \includegraphics[width=0.6\textwidth]{CISC_scope-v3a_TDR.pdf}
\end{dunefigure}
...
\fixme{might make sense to move CFD down closer to fig 1-11? anne. We cannot figure out how to do this. [Glenn]}
