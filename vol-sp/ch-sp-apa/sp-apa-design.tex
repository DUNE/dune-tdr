...
\forlbnc{Finite Element Analysis has been conducted on the frames, both at room and LAr temperatures, and was part of an internal review in March.  A short summary and conclusions will be added here.}
...
The \SI{152}{$\mu$m} (\SI{.006}{in}) diameter beryllium copper (CuBe) wire chosen for use in the \dwords{apa} is known for its high durability and yield strength. It is composed of \num{98}\,\% copper, \num{1.9}\,\% beryllium, and a negligible amount of other elements. Each \dword{apa} contains a total of \SI{23.4}{km} of wire.  
