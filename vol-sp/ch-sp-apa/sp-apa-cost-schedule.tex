...
Analysis of the \dword{pdsp} data will inform the decision on the electron diverters by June 2019.  \fixme{done? check whole pgraph - and section} Additional design considerations that cannot be directly tested through \dword{pdsp}, like the \dword{apa} pair assembly and related cabling issues, will require a full test with cabling of an \dword{apa} pair frame assembly, planned to be performed at \dword{ashriver} by the end of summer 2019.  Also planned is the construction of a pre-production \dword{apa} for an integration test with \dword{ce} and \dword{pds}s at \dword{cern} in spring 2020, which will fully test all interface aspects. This test will inform the final design review of the \dword{apa} system in May 2020.
