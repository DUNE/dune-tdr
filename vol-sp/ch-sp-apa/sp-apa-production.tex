...
All components require inspection and \dword{qc} checks before use on an \dword{apa}.  Many of these tests will be performed at locations other than the \dword{apa} production sites by institutions within the consortium and the hardware shipped for use in \dword{apa} construction. 
