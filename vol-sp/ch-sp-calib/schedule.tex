...
\begin{dunetable}
%[Key calibration construction milestones for commissioning of the first \dshort{spmod}.]
...
Installation and commissioning & \fixme{Jun 2023} \\ 
\end{dunetable}
\end{comment}
...
Installation: Assembly at DUNE and QC & \fixme{2024} \\  % 
\end{dunetable}
\end{comment}
...
{p{0.65\textwidth}p{0.25\textwidth}}
{tab:lasersched}
{Laser Beam Location System Schedule}   
Milestone & Date (Month YYYY) \\ \toprowrule
...
Installation through TCO & \fixme{As soon as TCO open for installation} \\ \ % 
\end{dunetable}
\end{comment}
