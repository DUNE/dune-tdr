...
\SI{12x12}{\square\cm} \fixme{check} (equivalent to two profiles) opening, located at \SI{40}{\cm} (along the $x$ direction) from the \dword{apa}, is small and tolerable, since the unusable volume would be about \SI{2.2}{\litre}. These simulations need to be redone with a larger opening of \SI{18x18}{\square\cm}  (three profiles).
