...
\begin{dunetable}[Compressed size for Raw data - 7 GeV beam event]{rrl}{tab:comp-raw-data-size}{Compressed size for Raw data - 7 GeV beam events}
...
\begin{dunetable}[Compressed size for Reconstructed data - 7 GeV beam event]{rrl}{tab:comp-raw-data-size}{Compressed size for Reconstructed data - 7 GeV beam events}
Size in kBytes&	Fraction&		Data Product Name	\\
...
The downstream pattern recognition steps starting with \dword{roi} are described further in the Tools and Methods chapter of the Physics Volume.  For the first reconstruction pass in November, the main algorithms used the Pandora framework \cite{Acciarri:2017hat}.
