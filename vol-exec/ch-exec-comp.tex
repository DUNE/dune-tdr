...
\textit{
This chapter briefly describes the DUNE computing model, which touches on all elements of the \dword{nd} and \dword{fd} and their physics programs.  More detailed aspects of the model may be found in Appendix~\ref{appx:es-comp}.  DUNE will produce a complete technical design report for computing over the next two years.}
...
\dword{csc} management currently %fills other roles by asking for volunteers. (LBNC 12/2)
...
The \dword{csc} member institutions (see Table~\ref{tab:exec-comp-consortium}) focus on the hardware and software infrastructure for offline computing.  Responsibility for developing algorithms resides %externally within 
