...
\appendix{The Near Detector Purpose and Conceptual Design}
\label{ch:appx-nd}
...
%\section
\appendix{Beyond Standard Model Opportunities with the ND}
...
\appendix{Constraining the Flux in the ND}
