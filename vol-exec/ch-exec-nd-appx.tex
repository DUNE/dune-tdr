...
{Muon acceptance shown as a function of true neutrino energy (left) and true muon energy (right).  The acceptance for muons that stop in \dword{arcube} is shown in red and that for muons reconstructed in the downstream magnetic spectrometer is shown in blue.}
      \includegraphics[width=0.45\textwidth]{graphics/muReco_Ev.png}
      \includegraphics[width=0.45\textwidth]{graphics/muReco_Emu.png}
\end{dunefigure}
...
{The results of a full two-flavor, antineutrino+neutrino, near+far oscillation fit are shown for a fit to the nominal \dword{mc} (dashed) and a fit to the fake data set (solid). The true values of the oscillation parameters in each of the data sets are indicated by the dashed yellow lines. Clear biases can be see in all oscillation parameters that are well outside the 1$\sigma$ (black), 2$\sigma$ (red), and 3$\sigma$ (blue) contours.}
      \includegraphics[width=0.85\textwidth]{graphics/fakedatafitresults.png}
\end{dunefigure}
...
{A comparison between the fake data (green) and nominal Monte Carlo (red) reconstructed neutrino energy distributions are shown for the on-axis  \dword{nd} location (left) and a position \SI{18}{m} off-axis (right).}
      \includegraphics[width=0.45\textwidth]{graphics/OffAxisEventRatePredictionPlots_Stop-0.png}
      \includegraphics[width=0.45\textwidth]{graphics/OffAxisEventRatePredictionPlots_Stop-5.png}
\end{dunefigure}
...
{Linear combinations of off-axis fluxes giving far-detector oscillated spectra for a range of oscillation parameters. The  \dword{fd} oscillated flux is shown in black, the target flux is shown in green, and the linearly combined flux obtained with the nominal beam MC is shown in red. Systematic effects due to 1 $\sigma$ variations of the decay pipe radius (green), horn current (magenta) and horn cooling water layer thickness (teal) are shown.}
	\includegraphics[width=0.7\textwidth]{graphics/nuprism_coef_oscSpectrum_0_0022_0_5.pdf}
	\includegraphics[width=0.7\textwidth]{graphics/nuprism_coef_oscSpectrum_0_0025_0_65.pdf}
\end{dunefigure}
...
{A few plastic scintillator cubes assembled with \dword{wls} fibers.}
  \includegraphics[width=3.in]{graphics/cube.png}
\end{dunefigure}
...
%\begin{figure}
%\begin{center}
%  \includegraphics[width=3.5in]{graphics/Target_cube_spectra.pdf}
...
\includegraphics[width=7.5in]{graphics/Target_photon_conversion.png}
\includegraphics[width=7.5in]{graphics/Target_stopped_proton.png}
\end{dunefigure}
...
\includegraphics[width=5.in]{graphics/beamcenter.jpg}
%\includegraphics[width=5.in]{graphics/Spectmonitor.jpg}
\end{dunefigure}
...
corresponds to a neutron indirect signature produced by the antineutrino interaction.}
  \includegraphics[width=5in]{graphics/event-display-neutron-yz.png}
\end{dunefigure}
...
{Reconstructed neutron energy residual with lever arm larger than 0.5~m and smaller than 1~m for 100 MeV for a 2.4$\times$2.4$\times$2.0~m$^{3}$ \dword{3dst} detector.}
  \includegraphics[width=5in]{graphics/neutronERes.png}
\end{dunefigure}
...
{Time difference between the neutrino interaction vertex time inside the 1.0$\times$1.0$\times$1.0~m$^{3}$ \dword{fv} core of the \dword{3dst} and the earliest neutron-induced hit time. The neutron-induced hit leaves at least 0.5 MeV in a single cube. The neutron-induced background hits arise from neutrons produced in neutrino interactions outside the \dword{fv}.}
  \includegraphics[width=5.2in]{graphics/timeDist.png}
\end{dunefigure}
...
See text for details.}
  \includegraphics[width=5in]{graphics/nominal_purity3-cut.png}
\end{dunefigure}
...
See text for details.}
  \includegraphics[width=5in]{graphics/nominal_resolution3-cut.png}
\end{dunefigure}
