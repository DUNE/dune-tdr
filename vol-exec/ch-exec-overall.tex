...
\dword{arcube} is large enough to provide high statistics (\num{1e8} $\numu$  charged current events/year on-axis), and its volume is sufficiently large to provide good hadron containment.  The tracking and energy resolution, combined with the \dword{lar} mass, will allow measurement of the neutrino beam using several techniques. %, including the well understood but rare process of $\nu$+e$^{-}$ scattering.
