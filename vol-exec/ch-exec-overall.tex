...
{fig:pdtpcpd}
{Calibrated $dE/dx$ versus residual range measured by \dword{tpc} for 1 GeV/c stopping protons (left) and response of ARAPUCA photon-detector module in \dword{apa}{}3 as a function of incident electron kinetic energy (right).} \includegraphics[width=0.47\linewidth]{graphics/dedx_rr_data_v5.pdf}
