...
Upon request from the \dword{fnal} director, the \dword{lbnc} may task other \dword{dune} and \dword{lbnf} groups to provide more detailed reports and evaluations of specific systems.
...
{tab:es-key-dates}
{(Sample subsystem) construction schedule milestones leading to commissioning of the first FD module. Key DUNE dates and milestones, defined for planning purposes in this TDR, are shown in orange.  Dates will be finalized following establishment of the international project baseline.}   
...
The schedule for the initial work is driven by the \dlong{cf} design and construction at each site.
...
The fourth module could use a different \lartpc technology, taking into account  potential advances in technology, to enhance sensitivity for physics discoveries. 
