...
\textit{This chapter provides a brief introduction to the \dword{sp} far detector technology.  The text below closely follows that found in the introductory chapter of Volume~\volnumbersp{}, \voltitlesp{}, where many more details may be found.}
