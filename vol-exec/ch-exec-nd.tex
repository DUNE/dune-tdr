...
\begin{dunetable}[Components of the \dword{dune} \dword{nd}]
{p{.22\textwidth}p{.22\textwidth}p{.22\textwidth}p{.22\textwidth}}
{NDsumm}{This table gives a high-level breakdown of the four major components of the \dword{dune} \dword{nd} along with function and primary physics goals.}
...
\begin{itemize}
    ...
    \item There may be small but significant differences in the $\nu_{\mu}$ and $\nu_{e}$ \dword{ccqe} cross sections which are poorly constrained \cite{Day:2012gb}.
