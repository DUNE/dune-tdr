...
\textit{
This chapter provides a brief introduction to \dshort{dune} physics.  The text below closely follows the presentation in the introductory chapters of Volume~\volnumberphysics{}, 
...
\fixme{It sounds like they're too rare in the MW or Andromeda, even combined, to be likely to be captured by DUNE; do you mean core collapses beyond these galaxies?}
...
in Section~\ref{exec:strategy-fd-des}. \fixme{check section}
% end JU 1/21
...
The \dword{dune} \nue and \anue event yields represent order-of-magnitude increases relative to 
those in the current \dword{nova} and \dword{t2k} data samples, while the 
