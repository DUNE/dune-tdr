...
neutrino states can
become particularly sizable the lower the mass of the new states.
...
One of the primary physics advantages DUNE is the simultaneous measurement of all oscillation parameters governing long-baseline neutrino oscillation, without a need for external constraints. As an example, Figure~\ref{fig:res_th23vdcp_degen} shows the 90\% C.L.\ allowed regions for \sinst{23} and \deltacp for 7, 10 and 15 years of running, 
