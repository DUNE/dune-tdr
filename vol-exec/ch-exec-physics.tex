...
\includegraphics[width=0.75\linewidth]{graphics/cpv_exp_staging_varyconstr_nh_2019_v4.png}
\end{dunefigure}
...
{Significance of the DUNE determination of the neutrino mass ordering for the case when \deltacp=$-\pi/2$, and for 100\% of possible true \deltacp values, as a function of time in calendar years. True normal ordering is assumed. The width of the band shows the impact of applying an external constraint on \sinstt{13}.}
	\includegraphics[width=0.75\linewidth]{graphics/mh_exp_staging_varyconstr_nh_2019_v4.png}	
\end{dunefigure}
...
{Resolution in degrees for the DUNE measurement of \deltacp, as a function of the true value of \deltacp, for seven (blue), ten (orange), and fifteen (green) years of exposure. True normal ordering is assumed. The width of the band shows the impact of applying an external constraint on \sinstt{13}.}
		\includegraphics[width=0.75\linewidth]{graphics/dcpresvdcp_smooth_v4.png}
\end{dunefigure}
...
In this case, \sinstt{13} is constrained by \dword{nufit}.
		...
		\includegraphics[width=0.5\linewidth]{graphics/bubbles_q23_asimov0_2019.png}
\end{dunefigure}
%
% end JU 1/21
...
{Sensitivity to determination of the $\theta_{23}$ octant as a function of the true value of \sinst{23}, for ten (orange) and fifteen (green) years of exposure. True normal ordering is assumed. The width of the transparent bands cover 68\% of fits in which random throws are used to simulate statistical variations and select true values of the oscillation and systematic uncertainty parameters, constrained by pre-fit uncertainties. The solid lines show the median sensitivity.}
		\includegraphics[width=0.5\linewidth]{graphics/octant_no_2019_v4.png}
\end{dunefigure}
...
\includegraphics[width=0.45\linewidth]{graphics/proton_dedx_resrange_run5387.pdf}\hspace{0.05\linewidth}
\includegraphics[width=0.45\linewidth]{graphics/muon_run5387_dedx.pdf}
\end{dunefigure}
...
\begin{dunefigure}[Supernova direction determination from $\nu-e$ elastic scattering events]{fig:fullSN_execsum}{Left: Log
  ...
  \includegraphics[width=0.48\textwidth]{graphics/costheta_fullSN_ESCCPDFs_TDR.pdf}
\end{dunefigure}
...
$\vcenter{\hbox{\includegraphics[width=0.70\columnwidth]{graphics/ComboLimit90_dune_sbn.pdf}}}$
\end{dunefigure}
...
\includegraphics[width=0.75\textwidth]{graphics/LmuLtau_zoom.pdf}
\end{dunefigure}
