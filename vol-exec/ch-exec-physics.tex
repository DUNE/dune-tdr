...
\si{10^{34}}{year} level, as indicated in Sec.~\ref{sec:es:phys:pdecay}.
% end JU 1/21
...
candidates from direct detection and \dword{lhc} experiments has resulted in a reconsideration of the \dword{wimp} paradigm, and has revitalized the effort to search for light dark matter candidates 
...
with the large-scale \dword{protodune} detectors staged at \dword{cern}, 
