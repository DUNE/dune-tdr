...
Other advantages of the \dword{dp} design include accessible readout electronics and fewer detector components, reducing both costs and installation logistics.
  %The ionization electrons drift along an \efield towards a segmented anode where they deposit their charge. 
...
Amplification of the electron signal in the gas phase mitigates the potential effect of both factors on the performance.  On the other hand, due to the longer drift length, the \dword{dp} design requires a higher voltage (up to \SI{600}{kV}) on the cathode. \fixme{how does higher voltage affect the purity and noise?}
