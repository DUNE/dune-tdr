...
%Each of these steps will be discussed in detail in separate sections below. Various improvements to reconstruction could improve this pointing resolution. The model used in this study will be made more realistic by adding noise and all neutrino interactions in order to accurately estimate DUNE's real pointing resolution for supernovae.



% \begin{figure}
% \centering
% \includegraphics[width=0.6\textwidth]{evd1e1025MeV.png}
% \caption{\label{fig:1eevd}Example event display for a single simulated 10.25~MeV electron, with track reconstruction.}
% \end{figure}

% \begin{figure}
% \centering
% \includegraphics[width=0.8\textwidth]{costheta_2025MeV_PMdQdx.pdf}
% \caption{\label{fig:1ecostheta}Cosine of angular difference for 1000 20.25~MeV single electron events.}
% \end{figure}
...
% \begin{figure}
% \centering
%\includegraphics[width=0.8\textwidth]{pointres_vs_energy_1e_abs_PMdQdx.pdf}
% \caption{\label{fig:1epointres}Pointing resolution for single electron events versus electron energy.}
% \end{figure}
