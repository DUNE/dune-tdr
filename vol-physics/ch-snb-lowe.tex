...
\begin{dunefigure}[Pointing for full supernova]{fig:fullSN}{Left: Log
    ...
    shown in red,
  have the distribution of absolute value $\cos \theta$ plotted for display purposes. }
...
Of course, if the mass hierarchy is already known, we can turn it around 
...
mass hierarchy based on absolute neutronization-burst counts.  Note that there will be additional information from other time eras of the burst signal.  Further studies for a
