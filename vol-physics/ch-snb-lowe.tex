...
spectrum from ES, as has been used for most solar neutrino
observations so far. This feature enables more precise spectral measurements.
...
threshold and 31\% $\nu_e$ survival, is $\sim$100 per day.
...
We are optimistic that with sophisticated event selection, and possibly
...
yet unknown, and a huge exposure ($>$\SI{500}{\ktyr})
