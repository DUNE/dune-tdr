...
\begin{dunefigure}[Fit to three pinching
  ...
  given directly from the reference; for the Huedepohl models, they are fit to a
  time-integrated flux.}
	\includegraphics[scale = 0.37]{TDRPlot_Interpolated_ComparingDifferentFluxModels_ExtendedBounds.png.png}
  \end{dunefigure}
...
\begin{dunefigure}[Example of distance
  effect]{fig:exampleAsimovDistance}{Sensitivity regions generated
	...
	\includegraphics[scale = 0.37]{TDRPlot_Interpolated_20MARLEY_DifferentDistances.png}
  \end{dunefigure}
