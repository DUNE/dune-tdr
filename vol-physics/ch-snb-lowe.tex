...
\includegraphics[width=0.45\textwidth]{smear_nue_Ar40_ar40kt_MARLEY_NoDC.png}
\includegraphics[width=0.45\textwidth]{smear_nue_Ar40_ar40kt_DCT.png}
...
\begin{dunefigure}[Pointing for full
  supernova]{fig:fullSN}{Distribution of angular differences for
    directions to a 260-ES-event supernova using a maximum likelihood method.}
  \includegraphics[width=0.6\textwidth]{costheta_SN_llhminbin_finebins.pdf}
\end{dunefigure}
...
Fig.~\ref{fig:fullSN}.  Overall resolution is about 9 degrees.  This result assumes perfect selection of
