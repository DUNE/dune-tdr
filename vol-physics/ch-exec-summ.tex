...
has been made to the extent that robust event reconstruction 
codes can be run on fully simulated neutrino interaction events 
in DUNE far detector modules, the DUNE computing infrastructure allows larproduction 
Robust end-to-end analyses not 
possible a year ago have now been done and are reported in this document.
...
Consequently, practical considerations, including human 
resource availability, have led to different levels
