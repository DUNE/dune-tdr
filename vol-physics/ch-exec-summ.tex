...
error, as described in detail in Chapter~\ref{ch:osc}.  Strong evidence ($>3\sigma$) for \dword{cpv} is obtained for favorable values (half of the phase space) of \deltacp after six years of running, leading to a $>5\sigma$ determination after 11 years.
...
\begin{dunefigure}[Supernova direction determination from $\nu-e$ elastic scattering events]{fig:fullSN_execsum}{Left: Log
  ...
  \includegraphics[width=0.48\textwidth]{costheta_fullSN_oldPDFs.pdf}
\end{dunefigure}
