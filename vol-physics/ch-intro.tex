...
\dword{enc} amounts to $\approx 550$ $e^{-}$ on the collection 
...
\dword{s/n} is 14 (U) and 17 (V), exceeding the requirement of %a ratio $9/1$ 
...
detectors (including ARAPUCAs) embedded within the \dwords{apa}.
