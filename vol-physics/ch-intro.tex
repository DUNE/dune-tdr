...
\includegraphics[width=0.99\textwidth]{graphics/caverns_full_assembly}
\end{dunefigure}
...
\includegraphics[width=0.95\textwidth]{graphics/beamline-sideview.jpg}
\end{dunefigure}
...
\includegraphics[width=0.65\textwidth]{graphics/DUNESchematic.pdf}
\end{dunefigure}
