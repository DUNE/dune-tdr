...
\includegraphics[width=0.48\columnwidth]{graphics/MultiPlots_DUNE_th14_prelim}
\includegraphics[width=0.48\columnwidth]{graphics/MultiPlots_DUNE_MINOS_IceCube_globAppF_prelim.pdf}
\end{dunefigure}
...
\includegraphics[width=0.48\columnwidth]{graphics/MultiPlots_DUNE_th34_prelim1}
\end{dunefigure}
...
$\vcenter{\hbox{\includegraphics[width=0.48\columnwidth]{graphics/ComboLimit90_dune_sbn.pdf}}}$
$\vcenter{\hbox{\includegraphics[width=0.42\columnwidth]{graphics/Dis_Pot_tme.pdf}}}$
\end{dunefigure}
...
\includegraphics[width=0.8\columnwidth]{graphics/TDR12.pdf}
\end{dunefigure}
...
\begin{figure}[!htb]
 \centering
        \includegraphics[width=0.45\columnwidth]{graphics/imposter-sq23.pdf}
...
\begin{figure}[!hb]
\centering
\includegraphics[width=0.27\textwidth]{graphics/trident_diagram_mumu_W.pdf} \qquad
\includegraphics[width=0.27\textwidth]{graphics/trident_diagram_mumu_Zprime.pdf} \\[\baselineskip]
\includegraphics[width=0.27\textwidth]{graphics/trident_diagram_ee_Z.pdf} \qquad
\includegraphics[width=0.27\textwidth]{graphics/trident_diagram_mue_W.pdf} \\[\baselineskip]
...
\begin{figure}[t]
\centering
 \includegraphics[width=0.30\linewidth]{graphics/MesonDecay_2Body.pdf}
    \includegraphics[width=0.30\linewidth]{graphics/MesonDecay.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=9cm]{graphics/signature}
...
\begin{figure}[t]
\centering
\includegraphics[width=6cm]{graphics/inv_PD_vs_DUNE} 
\includegraphics[width=6cm]{graphics/vis_PD_vs_DUNE} \\
\vspace{0.3cm}
\includegraphics[width=6cm]{graphics/inv_DUNE_p-scatterings}
\includegraphics[width=6cm]{graphics/vis_DUNE_p-scatterings}
...
\begin{figure}[t]
\centering
\includegraphics[width=6cm]{graphics/SigmaFluxVslMaxLab_TotalOnly}
\includegraphics[width=6cm]{graphics/SigmaVsE1}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.7\textwidth]{graphics/processes.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.256\textwidth]{graphics/elastic-diagram.pdf}
  \includegraphics[width=0.33\textwidth]{graphics/resonant-diagram.pdf}
  \includegraphics[width=0.29\textwidth]{graphics/deepinelastic-diagram.pdf}
...
\begin{figure*}[!htb]
\centering
\includegraphics[width=0.45\textwidth]{graphics/bdm_preliminary_125_sa}\hspace{0.05\textwidth}
\includegraphics[width=0.45\textwidth]{graphics/bdm_preliminary_10_sa_legend}
...
DUNE will be a powerful discovery tool on a variety of physics topics under very active exploration today, from the potential discovery of new particles beyond those predicted in the \dword{sm}, to precision neutrino measurements that may uncover deviations from the present three-flavor mixing paradigm and unveil new interactions and symmetries.
