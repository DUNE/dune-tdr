    ...
    \begin{center}
        ...
        \resizebox{0.6\textwidth}{!}{
            \begin{tabular}{ | l  l |} 
               ...
               \hline
               ND dimensions dimension & 7m(W) x 3m(H) x 5m(L) \\ ND active volume & 6m(W) x 2m(H) x 4m(L) \\
