...
%    \centering
%    \begin{tabular}{cc}
%		\includegraphics[width=0.475\linewidth]{graphics/ccNumu1ProtonProb.pdf} &
%		\includegraphics[width=0.475\linewidth]{graphics/nc1PizeroProb.pdf}
%	\end{tabular}
...
%    \includegraphics[scale=0.3]{graphics/cvn_placeholder.pdf}
