...
\def\voltitleexecsum{Physics, Technologies, and Strategies\xspace}
\def\voltitlephysics{DUNE Physics\xspace}
\def\voltitlespfdm{Single-Phase Far-Detector Module\xspace}
\def\voltitledpfdm{Dual-Phase Far-Detector Module\xspace}
\def\voltitlend{Near Detector\xspace}
\def\voltitlesandc{Software and Computing\xspace}
\def\voltitletechcoord{Technical Coordination\xspace}
