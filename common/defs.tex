...
% use for inter-volume referencing
% Commented out because it breaks the WAF building system
% \usepackage{xr-hyper}
% \externaldocument[exec:]{vol-exec}
% \externaldocument[physics:]{vol-physics}
% \externaldocument[sp:]{vol-sp}
% \externaldocument[dp:]{vol-dp}
% \externaldocument[nd:]{vol-nd}
% \externaldocument[swc:]{vol-swc}
% \externaldocument[tc:]{vol-tc}
% \newcommand{\refsec}[2]{Volume~\csname volnumber#1\endcsname \xspace Section~\ref{#1:#2}}
% \newcommand{\refch}[2]{Volume~\csname volnumber#1\endcsname \xspace Chapter~\ref{#1:#2}}
% \newcommand{\refvol}[2]{\ref{#1:#2} in Volume~\csname volnumber#1\endcsname \xspace}
