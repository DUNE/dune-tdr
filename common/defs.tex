...
% Names of expts or detectors -- all these go into glossary
...
% Random -- all these go into glossary
...
\newcommand{\coldbox}{coldbox\xspace} % standardize w/ or w/o space or hyphen
%\newcommand{\endwall}{end wall\xspace} % standardize w/ or w/o space
\def\endwall{end wall\xspace}
...
%detector components SP and DP -- need to be in gloss
...
\newcommand{\frfour}{FR-4\xspace} % add to gloss
