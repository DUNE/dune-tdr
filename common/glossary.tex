...
%far detector
\newduneabbrev{fd}{FD}{far detector}{Refers to the \fdfiducialmass fiducial mass DUNE detector, composed of four \nominalmodsize modules,  %or more generally the experimental 
...
\newduneword{pdsp}{ProtoDUNE-SP}{The \gls{sp} ProtoDUNE detector at \gls{cern}}

%the dual-phase ProtoDune detector
\newduneword{pddp}{ProtoDUNE-DP}{The \gls{dp} ProtoDUNE detector at \gls{cern}}
...
\newduneword{spmod}{SP module}{single-phase DUNE far detector module}
\newduneword{dpmod}{DP module}{dual-phase DUNE far detector module}
...
\newduneabbrev{sbn}{SBN}{Short-Baseline Neutrino}{A \gls{fnal} program consisting of three collaborations, \gls{microboone}, SBND, and \gls{icarus}, to perform sensitive searches for $\nue$ appearance and $\numu$ disappearance in the Booster Neutrino Beam.}
...
\newduneword{argoneut}{ArgoNeuT}{The ArgoNeuT test-beam experiment and \gls{lartpc} prototype at \fnal}
