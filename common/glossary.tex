...
\newduneabbrev{lsb}{Least Significant Bit}{The bit with a lowest numerical value in a binary number}
...
\newduneabbrev{wrmch}{WR-MCH}{White Rabbit \gls{utca} Carrier Hub}{A card mounted in \gls{utca} crate that recieves time syncronization information and trigger data packets over \gls{wr} network and disributesthem to the \gls{amc} over \gls{utca} backplane} 
