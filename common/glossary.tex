...
\newduneabbrev{wec}{WEC}{Warm Electronics Crate}{Electronics crate mounted on the feedthru Tees which hold the warm interface boards and power timing cards.}
