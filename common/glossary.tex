...
\newduneabbrev{ssp}{SSP}{SiPM signal processor}{add def}
\newduneword{sbn}{SBN}{Short-Baseline Neutrino program (at \fnal)}
\newduneabbrev{stt}{STT}{straw tube tracker}{add def}
...
\newduneabbrev{rtd}{RTD}{add def (RTD term)}{Cryostat level and temperature monitoring devices}
...
\newduneabbrev{hvdb}{HVDB}{HV divider board}{dual-phase HV divider board (add def)}
...
\newduneword{tdc}{TDC}{add def nu osc 07 - or get rid of}
