...
\newduneabbrev{ptb}{PTB}{power and timing backplane}{Backplane used to connect the \dwords{wib} and the \dword{ptc} on the \dword{wiec}. Also connects the \dworc{ce} flange on the cryostat penetration.}
