...
\newduneword{pll}{PLL}{Phase-Locked Loop}
...
\newduneword{snowglobes}{SNOwGLoBES}{add def}
...
\newduneword{snr}{SNR}{Signal to noise ratio}
...
\newduneword{gibuu}{GiBUU}{Giessen Boltzmann-Uehling-Uhlenback Project; a unified theory and transport framework in the MeV and GeV energy regimes for elementary reactins on nuclei }
