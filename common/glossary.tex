...
\newduneabbrev{ipd}{IPD}{Integration Project Director}{Responsible for integration and installation of \dword{lbnf} and \dword{dune} deliverables in South Dakota. Manages the \dword{jpo}}
