...
4 & Overpressure in the \dwords{sftchimney} \\ \colhline
5 & Leak of nitrogen inside the \dword{dpmod} via cold flange \\ \colhline
6 & Data flow increase due to inefficient compression caused by higher noise \\ \colhline
7 & Damage to \dword{utca} crates due to presence of water on the roof of the cryostat \\ \colhline
8 & Problems with \dword{fe} card extraction due to insufficient clearance \\ \colhline
