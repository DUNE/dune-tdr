...
Potential damage to the \dword{utca} crates due to water condensation on the roof of the cryostat (ID 8) or poor air quality (ID 9) should be mitigated by the requirements to the LBNF that the top of the cryostat stays dry and the air quality remains similar to any industrial environment (e.g., at CERN or Fermilab). Liberation of large quantities of dust in the detector caverns at SURF should be avoided after the deployment of the \dword{utca} crates.
