...
\fixme{Again, a brief introductory statement here would clarify the logic of the section.}
...
The key schedule milestones are listed in Table~\ref{tab:dp-tpcelec-milestones}. The dates given assume installation of the \dual TPC as the second \dword{fd} \dword{detmodule}.
