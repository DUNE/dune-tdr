...
The detailed cost model for the \dual TPC electronics system has been developed based on the scaling of the costs for the electronics system of \dword{pddp}. The core costs for the production of the electronics system to instrument a single \dword{dp} are summarized Table~\ref{tab:dp-tpcelec-costs}. 
\fixme{Need to put actual numbers and adapt the table format to the one used throught TDR}
...
{\dual TPC electronics system schedule \fixme{Check and correct dates for some milestones}}
