...
This section discusses the organization of the \dword{dp} \dword{tpc} electronics consortium responsible for delivering the \dword{cro} and \dword{lro} electronics for \dword{dpmod}. We present the planning assumptions, and give the schedule for production, integration, and installation of the system components. In addition, we provide a detailed breakdown of the core costs for principal components. 
...
Southern Methodist University & USA \\ %\colhline
\end{dunetable}
