...
The installing and operating the electronics system does not pose any particular or abnormal safety risks. %The handling of the e
...
During operation, the \dword{lv} power supplies for the \dword{fe} cards and \dword{utca} crates are powered from the standard mains system. They do not require any additional protection beyond what is %the ones 
