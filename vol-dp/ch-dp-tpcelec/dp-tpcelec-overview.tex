...
The design of the electronics system for the for \dword{dune} \dword{dpmod} is a result of an R\&D program that begun in 2006. Some of its key objectives has been developing and building custom analog and digital electronics circuits that are capable of performing continuous readout and are both cost-effective and easily scalable to meet the needs of a large-scale neutrino \dword{lar} detector. The design of the system went though several improvement phases and was finalized in 2016. The full-scale production of all of the components necessary for charge readout of \dword{pddp} was subsequently launched. In 2016 a subset of the produced electronics was deployed in the \dword{wa105} at CERN, a preliminary \dual \lartpc prototype with an active volume  of \SI[product-units=power]{3x1x1}{m} (\dword{crp} area of \SI[product-units=power]{3x1}{m}) that took data in the summer-fall of 2017. Operation of the \dword{wa105} \cite{Aimard:2018yxp} validated the design choices for the electronics and provided checks on various performance markers like noise. Figure~\ref{fig:dp-tpcelec-311-dqds-etaucorrected} shows a distribution of charge obtained from reconstructed cosmic muon tracks for both collection views. Given the average \dword{mip} charge loss expected in liquid argon after taking into account recombination is around \SI{10}{\femto\coulomb/\cm}, the effective gain of \dword{crp} in the \dword{wa105} was between \numrange{3}{4}.
