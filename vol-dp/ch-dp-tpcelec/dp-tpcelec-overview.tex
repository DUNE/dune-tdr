...
The design of the electronics system for the \dword{dune} \dword{dpmod} is the result of an R\&D program that begun in 2006. Some of its key objectives have been developing and building custom analog and digital electronics circuits optimized for \dword{dp} operation and %capable of 
...
this allows decoupling of these parts from the analog stage and placing them %at warm 
outside%of 
the cryostat. A key criterion of the R\&D was to create cost-effective and easily scalable solutions to meet the needs of a large-scale neutrino \dword{lar} detector. The design, finalized in 2016,  went though several prototyping phases. % being continuously improved in the process. It was finalized in 2016. 
...
with an active volume  of \SI[product-units=power]{3x1x1}{m} (\dword{crp} area of \SI[product-units=power]{3x1}{m}), that took data in the summer and fall of 2017. The operation of the \dword{wa105} \cite{Aimard:2018yxp} gave early validation of theelectronics  design choices %for the electronics 
