...
required such that an \dword{eb} may properly query the \dword{daqubi} and
...
\dword{daqubi} must be accomplished promptly compared to the depth of the
upstream DAQ buffer.
...
appropriate \dfirst{daqubi}, as addressed by a received trigger command. 
...
\begin{dunefigure}{fig:daq:felix-pd-impl}{The topology of the FELIX based
...
Figure~\ref{fig:daq:felix-pd-impl}.
