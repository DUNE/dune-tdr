...
\dword{pdsp} and \dword{pddp} are testing the performance of all cryogenics instrumentation for the \dword{dpmod}, validating the baseline  %\dword{fd} 
...
The first \SI{5.5}{m} of \dword{lar} will be monitored by cameras and by the vertical arrays of \dwords{rtd}. Once the liquid reaches the level of the cryogenics pipes going out of the cryostat, 
