...
The \dword{hv} cables penetrate a feedthrough flange and end with SHV connectors, with the calibration fibers also penetrating a feedthrough flange and end with SMA connectors. One DN250 flange is used per sector of \dual \dword{pds}. One flange houses \num{36} SHV and \num{6} SMA connections. The \dual \dword{pds} design has \num{20} penetrations on the cryostat roof, one per sector. 
