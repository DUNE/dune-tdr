...
\includegraphics[width=0.7\textwidth]{graphics/dppd_LCSdiagram_DUNE}
\end{dunefigure}
...
\includegraphics[width=0.25\textwidth]{graphics/dppd_LightGuide.jpg}
\includegraphics[width=0.6\textwidth]{graphics/dppd_Stray.png}
\end{dunefigure}
