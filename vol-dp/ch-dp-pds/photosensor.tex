...
\begin{dunefigure}[Set up for \dshort{pmt} characterization tests]{fig:dppd_2_2b}
...
\dword{tpb} is a wavelength shifter that has high efficiency for converting \dword{lar} scintillation \dword{vuv} light toward the light for which the \dword{pmt} photocathode is more sensitive. 
