...
\begin{dunefigure}[Picture of the PMTs being installed in the testing vessel]{fig:dppd_2_2a}
...
\begin{dunefigure}[Sketch of the set up for PMT characterization tests.]{fig:dppd_2_2b}
...
\begin{dunefigure}[Sketches of the front and side views of the reflective foil/WLS panel.]{fig:dppd_reflective_panel}
