...
\item \dword{hv}: This interface includes the consideration of the distance between the cathode/ground grid and the \dword{pmt} planes, the possible implementation of the ground grid at the individual \dword{pmt} level, and the possible implementation of the wavelength shifting foils on the inner surface of the \dword{fc}. The \dword{hv} consortium and \dword{pds} consortium will be communicating to harmonize the underground installation.
...
\item \dshort{uit}: This interface with the \dword{uit} includes the transporting \dword{pds} components to and between underground areas, clean room activities and storage, and coordinating installation with the other teams. The details are described in Section~\ref{subsec:dp-pds-undergroundinstallation}.
