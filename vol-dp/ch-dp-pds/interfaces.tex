...
\item \dword{hv}: This interface includes the consideration of the distance between the cathode/ground grid and the \dword{pmt} planes, the possible implementation of the ground grid at the individual \dword{pmt} level, and the possible implementation of the wavelength shifting foils on the inner surface of the field cage. The \dword{hv} consortium will also be the primary group that the \dword{pds} consortium will be communicating in order to harmonize the underground installation.
...
\item \dune Physics: \dual \dword{pds} has interfaces with the overall physics requirements on energy and time together with classification of events, decay modes and neutrino flavors.
