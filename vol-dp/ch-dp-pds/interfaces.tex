...
%%%%% to here
 (e.g., saturation, recovery time, ringing, pre- and after-pulsing) will be provided by \dword{dp} \dword{pds}. The type of connectors used at the FE input panel will be determined by the \dword{dp} Electronics Consortium and will be implemented by \dword{dp} \dword{pds}.
