...
\begin{dunefigure}[Splitter box for ProtoDUNE-DP]{fig:dppd_4_3}
...
\begin{dunefigure}[SPE waveforms and amplitudes from WA105 at different voltages.]{fig:dppd_4_3_ab}{\dword{spe} waveforms (left) and amplitudes from the WA105 at different voltages (right).}
