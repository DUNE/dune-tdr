...
\begin{dunefigure}[Sample transportation box]{fig:dppd_11_2}
...
\begin{dunefigure}[A single TPB-coating station]{fig:dppd_11_4}
...
\begin{dunetable}
[Quantities related to the DP PDS installation]
{lc p{0.8\textwidth}}
{tab:dppd_t_11_1}
...
\begin{dunefigure}[Installation sequence of unit reflector/WLS panel assembly on the FC I-beams]{fig:dppd_reflective_panel_installation_sequence}
