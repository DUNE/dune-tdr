...
The \dword{snb} triggering efficiency, for the "half-foil" baseline \dword{pds} design, and as a function of \dword{snb} interactions in the active volume and as a function of \dword{snb} distance, is shown in Figure~\ref{fig:dppd_snbefficiency}. A trigger efficiency in excess of \num{90}\% is obtained up to \dword{snb} distances of approximately \SI{24}{\kilo\parsec}. Therefore, the \dword{pds} should yield a highly efficient trigger for \dword{snb} occurring anywhere in the Milky Way. At the \SI{20}{\kilo\parsec} distance of the galaxy  edge, about \num{80} \dword{snb} interactions in the \dpactivelarmass active mass are expected. 
...
\begin{dunefigure}[\dword{snb} triggering efficiency for different \dword{wls} foil configurations.]{fig:dppd_snbefficiency}
...
\begin{dunefigure}[Energy resolutions for few-GeV beam neutrino interactions using the \dword{pds}.]{fig:dppd_energyresolutions_nuecc}
