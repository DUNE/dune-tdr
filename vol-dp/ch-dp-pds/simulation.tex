...
\begin{dunefigure}[Expected 1D light yields in the full \dword{dp} \dword{fd} cryostat.]{fig:dppd_fd_light_yield_comparisons}
...
\begin{dunefigure}[Expected 2D light yield in the full \dword{dp} \dword{fd} cryostat.]{fig:dppd_fd_light_yield}
