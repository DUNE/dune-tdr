...
Over-pressure tests were carried out for \dword{pddp}, and further tests have ensured correct performance under pressure. An individual \dword{pmt} mount has been designed and tested in the  \dword{wa105} prototype~\cite{Zambelli:2017dkg}, and the same design is used for \dword{pddp}.
