...
The work on the \dword{dpmod} can profit from all the infrastructure already in place for the installation on the \dword{spmod}, like the \dword{cuc}, the underground mechanical workshop, the storage facility, the logistics organization, and so on.
...
Following leak checks and final electrical connection tests, the process of filling the cryostat with 17~kton of \dword{lar} begins.
...
\input{generated/req-just-DP-INST}the table~\ref{tab:requirements}.


In all the planning and future work, the preeminent requirement in the installation process is safety.
The installation of the \dword{dp} module presents a multitude of hazards that includes manipulation of heavy loads, work in tight areas and confined spaces, working at heights above the floor, use of chemicals (e.g., as cleaning agents), use of cryogens, and  tests involving \dword{hv}.
...
Further details of the overall \dword{dune} safety plan are provided in the Technical Coordination volume of this \dword{tdr}.
...
The high level risks associated to the \dword{dpmod} installation are summarized in Table~\ref{tab:risks:DP-FD-INST}.

\input{generated/risks-longtable-DP-FD-INST.tex}
