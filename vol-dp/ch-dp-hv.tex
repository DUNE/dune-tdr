...
\includegraphics[width=0.8\textwidth]{graphics/DP_HVS_dp-hvs-n-photos.png}
\end{dunefigure}
...
Some of these are examined in detail in Volume~\volnumberphysics{}, \voltitlephysics{}, of the
\dword{tdr}. 
...
\includegraphics[width=0.75\textwidth]{graphics/DP_HVS_dp-hvdb.png}
\end{dunefigure}
...
\includegraphics[width=0.9\textwidth]{graphics/DP_HVS_dp-fc-parts.png}
\end{dunefigure}
...
\includegraphics[width=0.75\textwidth]{graphics/DP_HVS_module-connection-installation.png}
\end{dunefigure}
...
Recent discussions with Heinzinger on the joint development of the cableless  \dptargetdriftvoltneg power supply have led them to propose a tentative schedule
with three major steps: %identified and proposed %directly by Heinzinger:

\begin{itemize}
\item As soon as the \SI{-300}{kV} power supply performs as expected in \dword{pddp},   a workshop will be organized %at \dword{cern} or at Heinzinger 
to finalize the technical performance requirements of the \dptargetdriftvoltneg power supply and a detailed plan for its design. A dedicated Heinzinger R\&D engineering team will take part in this workshop. 
%The workshop could presumably take place during2020 after the end of the commissioning phase of \dword{pddp} and after we reach the expected stable operation has been hopefullyproven. 

\item The %actual 
development phase of the \dptargetdriftvoltneg power supply will start %after %several months, estimated to be approximately
six to nine months later %to let Heinzinger complete their other ongoing commitments.  At that 
(due to Heizigner's other commitments), at which time the  Heinzinger R\&D  team will be fully
available  to  give high priority to this project. The production phase will follow development.

\item Heinzinger will deliver the  \dptargetdriftvoltneg power supply unit and a spare %(and eventually a spare) 
%should be delivered  
approximately a year and a half from the
start of the development phase. %This time estimate includes development and production phases. Its 
The expected duration is due to the design differences between the \dword{hv} cascade and the present highest-voltage power supply in production (\SI{-300}{kV}), and to the more complex
construction required. % will probably be more complex. 
\end{itemize}
The cascade of the \dptargetdriftvoltneg units will not be a straightforward, simple upgrade of the \SI{-300}{kV} type. During development, several tests and material/design verifications will be required, e.g., a new insulation layout scheme must be designed, and the corresponding insulating material must be chosen and carefully tested. Also,  other components and mechanical parts inside the cascade must be designed from scratch and tested separately.
             
  The schedule and cost of the project will be better understood after the power supply parameters and design are finalized. Note that Heinzinger has no plans for intermediate prototyping because, at the moment, they are developing these %is considered a special project with 
  power supply units solely for \dword{dune}. %produced only for our purposes.           
             
The %exact 
schedule and  actual cost of the project will be better understood after the 2019 summer workshop, when the %final 
design and the parameters of the unit will be finalized. %Note that no intermediate prototyping is foreseen by Heinzinger because, at the moment, this is considered a special project with power supply unit(s) produced only for our purposes.  Anne commented this part out as too detailed per Tim.
...
\includegraphics[width=0.5\textwidth]{graphics/DP_HVS_dp-hvps-750kv.png}
\end{dunefigure}
...
\includegraphics[width=0.75\textwidth]{graphics/DP_HVS_dp-hvft-extender.png}
\end{dunefigure}
...
\includegraphics[width=0.7\textwidth]{graphics/DP_HVS_cathode_frame_FEA.png}
\end{dunefigure}
...
\includegraphics[width=0.7\textwidth]{graphics/DP_HVS_cathode_E_field2.png}
\end{dunefigure}
...
\includegraphics[width=0.42\textheight]{graphics/DP_HVS_cathode_E_field_2D.png}
\end{dunefigure}
...
\includegraphics[width=0.6\textwidth]{graphics/DP_HVS_ground_grid_3x3.png}
\includegraphics[width=0.3\textwidth]{graphics/DP_HVS_ground_grid_plan_view.png}
\end{dunefigure}
...
\includegraphics[width=0.9\textwidth]{graphics/DP_HVS_FC_elevation.png}
\end{dunefigure}
...
\includegraphics[width=0.9\textwidth]{graphics/DP_HVS_FC_Sub_Module.png}
\end{dunefigure}
...
\includegraphics[width=0.9\textwidth]{graphics/DP_HVS_EW_corner_details.png}
\end{dunefigure}
...
\includegraphics[width=.45\textwidth]{graphics/DP_HVS_FC_module_interconnect_details.png}
\includegraphics[width=.4\textwidth]{graphics/DP_HVS_FC_cathode_connection_details.png}
\end{dunefigure}
...
\includegraphics[width=0.8\textwidth]{graphics/DP_HVS_FC_Profile_Resistive_Sheath.png}
\end{dunefigure}
...
assembly panels.}
%\includegraphics[width=0.9\textwidth]{graphics/DP_HVS_FC_super_module_reflector_installation_sequence.png}
\includegraphics[width=0.9\textwidth]{graphics/DP_HVS_FC_super_module_reflector_installation_sequence_v2}
\end{dunefigure}
