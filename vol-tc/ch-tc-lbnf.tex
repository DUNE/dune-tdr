...
\begin{dunefigure}[Overall view of the detector in cavern.]{fig:detector_cavern}
  ...
  \includegraphics[width=0.8\textwidth]{graphics/LBNF-Cryostat-NW_Iso_c.png}
\end{dunefigure}
...
\begin{dunefigure}[East-west elevation view of Detector]{fig:detector_ew_elevation}
  ...
  \includegraphics[width=0.9\textwidth]{graphics/LBNF-Cryostat-South_Elevation_in_Cavern_c.png}
\end{dunefigure}
...
\begin{dunefigure}[North-south elevation view of detector]{fig:detector_ns_elevation}
  ...
  \includegraphics[width=0.7\textwidth]{graphics/LBNF-Cryostat-West_Elevation_in_Cavern_c.png}
\end{dunefigure}
...
\begin{dunefigure}[Elevation view of top of cryostat showing mezzanines, cryogenic
  ...
  \includegraphics[width=0.85\textwidth]{graphics/LBNF-Cryostat-West_Elevation-Cryo_c.png}
\end{dunefigure}
