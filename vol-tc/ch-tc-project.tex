...
Review reports are in~\citedocdb{1584}.

\section{Design Reviews}

The \dword{dune} design review process is described in~\citedocdb{9564} and
...
\dword{dune} reviews are maintained in~\citedocdb{1584} along with the list
of recommendations.
