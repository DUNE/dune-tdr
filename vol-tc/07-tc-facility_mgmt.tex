...
technicians and engineers). The teams organized by \dword{tc} are:
\begin{enumerate}
 \item Technical coordination of activities \surf: this
   includes what \dword{tc} provides and interaction with consortia work
   at \surf.
 \item Technical coordination of activities \dword{itf}: this includes
   what \dword{tc} provides and how it interfaces with consortia work at \dword{itf}.
 \item Technical coordination of activities at the Ash River installation
   test site: this includes what \dword{tc} provides and how it
...
components at the surface and underground. \surf and the \dword{cmgc}
