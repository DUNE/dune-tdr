...
\end{enumerate}
 \item Ufer ground consisting of metal rebar embedded in concrete floors. The \dword{lbnf}/\dword{dune} Ufer ground system
...
The DDSS system will be implemented through hardware interlocks and a programmable logic controller
(PLC).  Listed below are some of \dword{dune} experimental conditions that would
