...
\item {\bf Cryogenic infrastructure}: This includes \dword{lar} and LN$_2$ receiving
  ...
  equipment.
\item {\bf Proximity cryogenics}: This include reliquefaction \fixme{Should this be reliquification?} and
...
conditions that would require the intervention of the \dword{ddss}:
\begin{enumerate}
