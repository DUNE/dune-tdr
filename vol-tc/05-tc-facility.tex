...
Each detector cavern is \SI{144.5}{\meter} long, \SI{19.8}{\meter} wide,
...
drifts at the east and west ends of each cavern, north and south side of
...
\begin{dunefigure}[Overall \dword{dune} grounding structure]{fig:dune-grounding}
  {Overall \dword{dune} groundging structure incorporated in cavern.}
