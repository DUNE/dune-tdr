...
and safety officer management goes directly to the
...
equipment inspection and training records is important to a strong
\dword{esh} program. All crane and equipment operation: rigging, scissor lift
operation and power tools are only operated by personnel with
proper training and have been certified for that
...
\fixme{Does SDSD have a role in user access monitoring? or training?
  Who hands out badges to someone arriving at SURF? Will there be a
