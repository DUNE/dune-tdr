...
activities at \dword{surf} including those that fall under the 
direct responsibility of \dword{lbnf} and the \dword{dune} consortia.  
...
\begin{dunefigure}[IO organization chart]{fig:ash_river}
...
The \dword{surf} is operated by the \dword{sdsta} through a cooperative 
...
on the facilties subsequent to departure of the \dword{lbnf} general 
contractor.         
