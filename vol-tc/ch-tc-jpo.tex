...
\begin{dunefigure}[Underground Detector Installation Team]{fig:uit_orgchart}
  {The \dword{uit}}
  \includegraphics[width=0.95\textwidth]{Org_UIT-TDR-7-20-19}
\end{dunefigure}
...
the University of Minnesota (UMN) and \dword{dune} that includes specialists 
as needed.
...
\end{dunefigure}
\fixme{add figure then uncomment}
