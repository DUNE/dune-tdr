...
the \dword{lbnf-dune} integration and installation activities both 
...
An Far Site \dword{esh} Coordinator sitting under the
\dword{lbnf-dune} \dword{esh} Manager oversees the day to day
execution of the integration and installation work. As we move to full
day installtion activity, additional Far Site \dword{esh} Coordinators
...
\dword{esh} manager oversee all on-site activites and has a direct 
...
the \dword{cuc}, this includes contractors.  Work within the detector caverns follows a time 
