...
required improvements to the detector caverns occuring after
\dword{aup} are managed by the underground cavern coordinator under
the direction of the \dword{ipd}.
...
\begin{dunefigure}[Common Technical Resources]{fig:ctr_orgchart}
  ...
  \includegraphics[width=0.95\textwidth]{Org_Technical_Resources-JPO-TDR-6-29-19a}
\end{dunefigure}
...
the \dword{dune} consortia.  The team is led by the underground
...
\begin{dunefigure}[Underground detector installation team]{fig:uit_orgchart}
  {The \dword{uit}}
  \includegraphics[width=0.95\textwidth]{Org_UIT-TDR-7-20-19a}
\end{dunefigure}

The underground installation manager oversees all shifts and serves as
...
chairperson of the \dword{dune}/UMN joint safety committee.  Two additional staff
