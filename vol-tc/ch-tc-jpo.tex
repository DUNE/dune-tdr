...
the \dword{surf} site.  The \dword{ipd} has direct responsibility for
...
directly to the \dword{ipd} to support the execution of this
responsibility.
...
\end{dunefigure}
As we move to full day installation activity,
...
discussions that take place during the toolbox meeting and for
...
coordinators of the different activities and crucial technical support
...
\begin{dunefigure}[far site organization chart]{fig:ash_river}
  ...
  \includegraphics[width=0.95\textwidth]{Org-Far-Site-TDR-7-21-19}
\end{dunefigure}
...
the detector installation effort sit directly within the \dword{jpo}
...
Engineering resources for installation activities sit directly within
...
\begin{dunefigure}[Common Technical Resources]{fig:ctr_orgchart}
  ...
  \includegraphics[width=0.95\textwidth]{Org_Technical_Resources-JPO-TDR-7-22-19}
\end{dunefigure}

On the surface at the start of each shift, there is a
...
\begin{dunefigure}[Underground detector installation team]{fig:uit_orgchart}
  {The \dword{uit}}
  \includegraphics[width=0.95\textwidth]{Org_UIT-TDR-7-22-19a}
\end{dunefigure}
...
\begin{itemize}
  ...
  \item {Phase 2:} A more complex steel structure will be 
         ...
         illustrated in Figure~\ref{fig:ashriver_tower} will provide 
