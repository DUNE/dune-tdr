...
procedures are up-to-date and stored within \dword{edms}.  
...
reporting line to the \dword{pid}.  Due to the lack of surface space 
...
under the direction of the \dword{pid}.

The \dword{pid} manages common technical and engineering resources 
...
\dword{sdsd}.  Approximately 6 months before benficial occupancy 
...
\dword{sdwf} is shown in Fig.~\ref{fig:sdwf}.  The facility 
...
\begin{itemize}
  ...
  \item Validate mechanical design changes made to the detector
    elements subsequent to \dword{protodune2} operation.
...
\begin{itemize}
  \item {\bf Phase 0:} A vertical cabling test using two full-scale 
         ...
         components. 
  \item {\bf Phase 1:} A prototype of the \dword{dune} \dword{apa} 
  ...
  \item {\bf Phase 2:} A more complex steel structure will be 
         ...
         of TPC components through the \dword{tco}, installation
         of the TPC end walls, cabling through the cryostat 
         penetrations, movement of the \dword{apa} and 
         \dword{cpa} pairs into their final positions, and 
