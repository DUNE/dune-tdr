...
\begin{dunefigure}[\dshort{dune} internal consortium structure]{fig:DUNE_consortia_org}
  ...
  \includegraphics[width=0.99\textwidth]{Internal_Consortia_OrgChart2}
\end{dunefigure}
...
\begin{dunefigure}[\dshort{dune} org chart]{fig:DUNE_org}
  ...
  \includegraphics[width=0.9\textwidth]{DUNE_Mgmt_20191001_v2}
\end{dunefigure}
...
\begin{dunefigure}[\dshort{dune} construction \dshort{esh}]{fig:dune_esh_construction}
  ...
  \includegraphics[width=0.85\textwidth]{DUNE_Construction_Safety_OrgChart}
\end{dunefigure}
