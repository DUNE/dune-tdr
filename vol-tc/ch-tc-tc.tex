...
\begin{dunefigure}[\dword{dune} technical coordination org chart]{fig:DUNE_tc}
  ...
  \includegraphics[width=0.99\textwidth]{TC_OrgChart2}
\end{dunefigure}
...
supported directly in this role by the \dword{lbnf-dune} \dword{esh}
...
through the \dword{jpo} Review Office to ensure coherence across the entire review
process.  The deputy \dword{tcoord} sits within the \dword{jpo} team and is
