...
are in place.  Follow-up onsite visits by the \dword{dune} \dword{esh}
...
associated with all operational conditions (both warm and cold) and 
...
enterprise.  The deputy \dword{tcoord} is a member of the \dword{jpo} 
...
infrastructure, for which the \dword{lbnf} project has direct responsibility.  
...
\rowtitlestyle  Phase        & Consortia    & \dword{tc}   & Collaboration & IO & \dword{lbnf} \\ \toprowrule
