...
organizational chart incorporating the basic structures manadated 
...
the \dword{lbnf-dune} schedule accordingly.  Milestones positioned 
at regular intervals within the subsystem construction schedules are 
incorporated to enable high-level tracking of these efforts.  Appendix 
Section~\ref{sec:fdsp-coord-controls} contains a table summarizing key 
detector milestones around which the the individual consortia schedules 
are constructed.
...
\begin{dunetable}
  [\dword{dune} responsibility]
  {|p{0.2\linewidth}|p{0.1\linewidth}|p{0.1\linewidth}|p{0.1\linewidth}|p{0.15\linewidth}|p{0.1\linewidth}|}
  {tab:responsibility}
  {Responsibility matrix for acitivites related to \dword{dune} \dword{fd} construction project}
                    & \dword{dune}    & \dword{dune} & \dword{dune}  &             &              \\ \colhline
  Process           & Consortia       & \dword{tc}   & Collaboration & \dword{jpo} & \dword{lbnf} \\ \toprowrule
  Design            & Lead            & Coordination & Support       & Support     &              \\ \colhline
  Prototype         & Lead            & Coordination & Support       & Support     &              \\ \colhline
  Fabricate         & Lead            & Coordination & Support       & Support     &              \\ \colhline
  Ship              & Lead            & Coordination & Support       & Support     &              \\ \colhline
  Receive           & Lead            & Support      & Support       & Coordinate  &              \\ \colhline
  Process           & Lead            & Support      & Support       & Coordinate  &              \\ \colhline
  Install           & Lead (Detector) & Support      & Support       & Coordinate  & Lead (Cryo)  \\ \colhline
  Commission - Cryo &                 &              & Support       & Coordinate  & Lead         \\ \colhline
  Commission - Det  & Lead            &              & Coordination  & Support     & Support      \\ \colhline
  Operate           & Lead            &              & Coordination  &             &              \\ \colhline \colhline
\end{dunetable}
...
\begin{dunetable}
  [\dword{dune} decisionmaking]
  {|p{0.2\linewidth}|p{0.2\linewidth}|}
  {tab:responsibility2}
  {Responsibility matrix for high-level decision-making during \dword{dune} \dword{fd} construction project}
                    & High-level               \\ \colhline   
  Process           & Decision-making          \\ \toprowrule
  Design            & \dword{dune} \dword{exb} \\ \colhline
  Prototype         & \dword{dune} \dword{exb} \\ \colhline
  Fabricate         & \dword{dune} \dword{exb} \\ \colhline
  Ship              & \dword{dune} \dword{exb} \\ \colhline
  Receive           & \dword{efig}             \\ \colhline
  Process           & \dword{efig}             \\ \colhline
  Install           & \dword{efig}             \\ \colhline
  Commission - Cryo & \dword{efig}             \\ \colhline
  Commission - Det  & \dword{dune} \dword{exb} \\ \colhline
  Operate           & \dword{dune} \dword{exb} \\ \colhline \colhline
\end{dunetable}
...
summarizes the bodies within the global project structure with  
responsibility for high-level decision-making during each stage of the 
\dword{dune} \dword{fd} construction project.  
