...
\begin{dunefigure}[DUNE work flow]{fig:DUNE_workflow}
...
highest-level risks identified by the consortia as well as the project
management risks self-held by the \dword{tc} organization.
