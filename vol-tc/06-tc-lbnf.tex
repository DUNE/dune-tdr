...
detector and facilities. Within the cavern items provided by \dword{lbnf} are
...
\begin{dunefigure}[Overall view of the detector in cavern.]{fig:detector_cavern}
  ...
  \includegraphics[width=0.85\textwidth]{LBNF-Cryostat-NW_Iso_c.png}
\end{dunefigure}
...
\begin{dunefigure}[East-west elevation view of Detector]{fig:detector_ew_elevation}
  ...
  \includegraphics[width=0.85\textwidth]{LBNF-Cryostat-South_Elevation_in_Cavern_c.png}
\end{dunefigure}
...
\begin{dunefigure}[North-south elevation view of detector]{fig:detector_ns_elevation}
  ...
  \includegraphics[width=0.85\textwidth]{LBNF-Cryostat-West_Elevation_in_Cavern_c.png}
\end{dunefigure}
