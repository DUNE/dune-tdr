...
on the left and the items provided by \dword{dune} are on the right. In addition, the \dword{tc} engineering team integrates the DAQ room in the central utility
...
\begin{itemize}
\item {\bf Detector:} All TPC elements within \dword{lar} are the responsibility of all consortia involved in
