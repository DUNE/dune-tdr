...
\begin{dunetable}
[\dword{dune} schedule milestones]
...
change control after each consortium agrees to the milestone dates and
the \dword{tdr} is approved.
...
\dword{tc}/\dword{jpo}. This will include updates on consortium and \dword{tc}
...
level detector specifications, including those listed above. These will be
