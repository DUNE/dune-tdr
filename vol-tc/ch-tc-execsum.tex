...
\fixme{Is it clearly understood that consortia provide `subsystems' of a detector module, not `systems'? anne (aha - it comes in 3rd pgraph}
...
organization.  \fixme{I reordered - I think it's better to define jpo before you say who sit in it}
