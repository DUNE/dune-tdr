...
criteria can be satisfied using a graded approach. This \dword{qap} is
...
the responsibility of the \dword{dune} Technical Coordinator and \dword{lbnf}/\dword{dune} \dword{qa} manager.
...
for achieving performance goals. The \dword{lbnf}/\dword{dune} \dword{qa} manager is responsible for
ensuring that a quality system is established, implemented and
maintained in accordance with requirements. The \dword{lbnf}/\dword{dune} \dword{qa} managerreports
...
Technical Coordinator and \dword{lbnf}/\dword{dune} \dword{qa} manager. \dword{dune} consortia leaders
may designate  \dword{qa} representatives  within their
organization to perform some of their work defined in the \dword{lbnf}/\dword{dune}
\dword{qa} plan. The \dword{dune} consortia leader shall retain overall
responsibility for these activities even though they have designated a
 \dword{qa} representative.
