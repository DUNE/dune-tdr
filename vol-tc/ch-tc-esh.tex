...
The \dword{tcoord} and Project Integration Director (PID) have
responsibility for implementation of the \dword{dune} \dword{esh}
program.  The \dword{lbnf}/\dword{dune} \dword{esh} Manager reports
directly to the \dword{tcoord} and PID and is responsible for
providing \dword{esh} support and oversight for development and
implementation \dword{dune} \dword{esh} program. The \dword{dune}
\dword{esh} Coordinators report to the \dword{lbnf}/\dword{dune} \dword{esh}
Manager and have primary responsibility for \dword{esh} support and
oversight of the \dword{dune} \dword{esh} program for all
activities at collaborating institutions and at \dword{lbnf}/\dword{dune}
