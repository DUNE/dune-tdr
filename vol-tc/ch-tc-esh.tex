...
operating \dword{dune}.
%Accidents and injuries are preventable, and we must work together to establish a workplace free of injuries. Finally, all work must be performed so the quality of the environment ispreserved, and property damage prevented.
The \dword{esh} program
...
contract between Fermi Research Alliance and the \dword{doe} Office of
...
Dakota Services Division is responsible for \dword{lbnf-dune}
...
near site \dword{esh} coordinators are responsible for providing
support and oversight for all installation activities at the
\dword{surf} and\dword{fnal} sites.
