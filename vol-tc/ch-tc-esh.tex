...
\subsection{Construction Hazards (\dword{lbnf-dune} HA-1)}
...
\subsection{Natural Phenomena (\dword{lbnf-dune} HA-2)}
...
\subsection{Environmental Hazards (\dword{lbnf-dune} HA-3)}
...
\subsection{Waste Hazards (\dword{lbnf-dune} HA-4)}
...
\subsection{Fire Hazards (\dword{lbnf-dune} HA-5)}
...
\subsection{Electrical Hazards (\dword{lbnf-dune} HA-6)}
...
\subsection{Noise/Vibration/Thermal/Mechanical (\dword{lbnf-dune} HA-7)}
...
\subsection{Cryogenic/Oxygen Deficiency Hazard (\dword{lbnf-dune} HA-8)}
...
\subsection{Confined Space Hazards (\dword{lbnf-dune} HA-9)}
...
\subsection{Chemical/Hazardous Materials Hazards (\dword{lbnf-dune} HA-11)}
...
\subsection{Lasers \& Other Non-Ionizing Radiation Hazards (\dword{lbnf-dune} HA-14)}
...
\subsection{Material Handling Hazards (\dword{lbnf-dune} HA-15)}
...
\subsection{Experimental Operations (\dword{lbnf-dune} HA-16)}
...
\section{\dword{lbnf-dune} \dword{esh} Program Requirements at \dword{surf}}
