...
\dword{lbnf} and \dword{dune} at \surf, hosted by
...
\surf, in Lead, South Dakota. The \dword{dune} project is committed to ensuring a
...
\dword{esh} program.  The \dword{lbnf}/\dword{dune} \dword{esh} Manager
...
\begin{dunetable}
  [Hazard List] {|p{0.4\textwidth}|p{0.3\textwidth}|p{0.35\textwidth}|}
...
The \dword{lbnf} Project is currently working with SDSTA and the \dword{lbnf}
...
are reviewed and evaluated by both \fnal management.
