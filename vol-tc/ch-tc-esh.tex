...
procedures. The \dword{esh} department at collaborating institutions
must be provide \dword{esh} oversight for all work activities carried
out in collaborating institution facilities. \dword{lbnf}/\dword{dune}
...
documentation reviews. The \dword{dune} Safety Committee membership
will include representation from all major stakeholders including
\fnal, CERN, \surf, \dword{dune} and collaborating institutions. The
...
The \dword{dune} team is comprised of experienced personnel from the
