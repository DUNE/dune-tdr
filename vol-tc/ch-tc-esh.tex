...
This assessment~\cite{bib:docdb122} \fixme{Anne added citation 11/6 - ok?}  identifies the
...
The \dword{lbnf-dune} \dword{esh} coordinator collects SDS documentation for chemicals and hazardous materials and determines proper storage cabinets for them. The \dword{ipd} approves the storage cabinets. The documentation is made readily available with the materials in the cabinets for the workers. \fixme{check edits 11/6}
