...
\dword{surf} Administrative Services Office. The \dword{surf}
identification badge allows access to the \dword{surf} site as part of
the \dword{surf} Site Access Control Program. The \fnal Global
Services Office has extensive experience with international
collaborators.
...
analyzed in the {\it \dword{lbnf-dune} Far Site Fire and Life Safety
  Assessment}~\citedocdb{1754}. The AON Fire Protection Engineering
...
criteria, {\it Fire Protection Assessment for the Far Site of
  \dword{lbnf}}~\citedocdb{317}.  ARUP provided code analysis, fire
...
features for LBNF Far Site facilities {\it A/E Services for
  ...
  Protection}~\citedocdb{10878}. Additionally, the ARUP 
...
\dword{lbnf-dune} for evacuation.  All caverns will be
...
signals will be monitored in the \dword{surf} Incident Command Center.
The \dword{surf} \dword{ert} will respond with additional support from
