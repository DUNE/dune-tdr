...
the necessary services provided by conventional facilities.
...
such, 3D mechanical modeling techniques are well suited for
...
agreed method and provide updated models for reintegration. With this process, models are kept in synchronization with only one-way integration and
...
Figure~\ref{fig:dune-sp_overall} shows the overall model of the\dword{dsp} far detector. One wall of the cryostat is removed for the interior
...
four Cathode Plane Assemblies and eight Field Cage plus Ground Plane
...
Figure~\ref{fig:dune-sp_transverse} shows the cross section of the
\dword{dsp} far detector in the transverse direction, along with overall
dimensions.
...
\end{dunefigure}
Figure~\ref{fig:dune-sp_long} shows the cross sections of the
\dword{dsp} far detector in the longitudinal direction, along with overall
dimensions.
...
Phase Detector, \dword{ddp}. One wall of the cryostat is removed for
the interior components to be visible. The detector is made from 20
rows.  Which are the same in construction. Each row consists of 4
CRPs, cathode, ground plane, PMTs and side-wall field cages. At the
...
\begin{dunefigure}[Overall model of the Dual-Phase Detector]{fig:dune-dp_overall}
  ...
  %  \includegraphics[width=0.85\textwidth]{logistics.pdf}
\end{dunefigure}
...
the latch connection latch between the field cages and APAs is also
shown.
...
Wiring diagrams include all wire and cable connections which
