...
\begin{dunefigure}[Interface between Anode Plane Assembly, upper Field Cages
    and Ground Plane]{fig:dune-apa_interfaces_mid}
...
\end{dunefigure}
\begin{dunefigure}[Interface between Cathode Plane Assembly, upper Field Cages
    and Ground Plane]{fig:dune-cpa_interfaces}
  {Interface between Cathode Plane Assembly, upper Field Cages and Ground Plane.}
...
earlier. Fig~\ref{fig:dune-apa_envelope} is a graphical representation
...
\begin{dunefigure}[Position of feedthrough determining the longitudinal
  ...
  {Position of feedthrough determining the longitudinal reference
