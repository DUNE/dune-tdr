...
The \dword{dsp} and \dword{ddp} detectors are large, made of many
...
\dword{dune} \dword{tc} generates and maintains 3D detector
...
determined. Please note that the \dword{tc} engineering team will not
...
\dwords{cpa} and eight \dwords{fc} and \dword{gp}. A total of 25 rows
...
assembly tolerances for the upper and lower \dwords{apa} and \dword{cpa} stacks have
...
Figure~\ref{fig:dune-apa_envelope} shows the design drift
