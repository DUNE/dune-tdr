...
\begin{dunefigure}[Overall model of one row of the Single-Phase Detector]{fig:dune-sp_row}
  ...
  \includegraphics[width=0.5\textwidth]{Model_one_row_SP.pdf}
\end{dunefigure}
...
\begin{dunefigure}[Section view of the Single Phase Detector in the transverse direction.]{fig:dune-sp_transverse}
  ...
  \includegraphics[width=0.5\textwidth]{SP_transverse_section.pdf}
\end{dunefigure}
...
\begin{dunefigure}[Interface between upper Anode Plane Assembly, Field Cage, cable trays and Detector Support System]{fig:dune-apa_interfaces_top}
  ...
  \includegraphics[width=0.6\textwidth]{Interface_upper_apa.pdf}
\end{dunefigure}
...
\begin{dunefigure}[Interface between lower Anode Plane Assembly,
  ...
  {Interface between lower Anode Plane Assembly, Field Cage and
    service floor.}
  \includegraphics[width=0.6\textwidth]{Interface_lower_apa.pdf}
\end{dunefigure}
...
\begin{dunefigure}[Interface between Anode Plane Assembly, upper Field Cages and Ground Plane]{fig:dune-apa_interfaces_mid}
  {Interface between Cathode Plane Assembly, upper Field Cages and Ground Plane.}
  \includegraphics[width=0.5\textwidth]{Interface_upper_mid_apa.pdf}
\end{dunefigure}
\begin{dunefigure}[Interface between Cathode Plane Assembly, upper Field Cages and Ground Plane]{fig:dune-cpa_interfaces}
  {Interface between Cathode Plane Assembly, upper Field Cages and Ground Plane.}
  \includegraphics[width=0.5\textwidth]{Interface_upper_cpa.pdf}
\end{dunefigure}
...
additional models as described earlier. Fig~\ref{fig:dune-apa_envelope} is a graphical
representation of Anode Plane and Cathode Plane Assemblies. It also
shows their relieve positions which defines how they are constrained in
the detector. 
...
{Interface of cryogenic distribution pipes, service floor and detector.}
  \includegraphics[width=0.5\textwidth]{Interface_lower_mid_apa.pdf}
\end{dunefigure}
...
\fixme{Can we rewrite as ``Consortia are responsible for system level block diagrams. TC
is responsible to ensure that block level diagrams are produced and reviewed.''?} In
