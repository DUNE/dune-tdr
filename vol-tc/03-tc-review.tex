...
The \dword{tc} reviews all stages of detector
development and works with each consortium to arrange reviews of the
design (conceptual design review (CDR), \fixme{Coding?} \dword{pdr}, and \dword{fdr}),
production (\dword{prr}, and \dword{ppr}), and \dword{orr} of their
system.  These reviews provide information to the TB \fixme{Coding?} to help in evaluating technical
...
the \dword{tc} engineering team. \Dword{tc} maintains a calendar
of \dword{dune} reviews.

\Dword{tc} works with consortia leaders to review all detector designs,
using first a \dword{pdr} followed by a \dword{fdr}.  All
major technology decisions will be reviewed before down-select.  \Dword{tc}
...
hold \dword{cdr} for systems with significant changes from
