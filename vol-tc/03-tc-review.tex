...
of protoDUNE components and has continued into the first \dword{dune}
...
review committees. \dword{tc} is responsible to keep informed of the
...
\dword{dune} reviews are maintained in DocDB-1584 along with the
recommendations.
