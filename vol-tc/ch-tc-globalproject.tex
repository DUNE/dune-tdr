...
are drawn from \dword{lbnf} project office, \dword{dune} \dword{tc}, 
...
responsible for administrating and managing the \dword{lbnf-dune}
document management system, which is hosted in the \dword{edms}.  All
technical documents and drawings are stored in the \dword{edms} system
...
for U.S. \dword{doe} contributions to \dword{lbnf} and \dword{dune}.
...
the \dword{jpo} review planning team to ensure coherence in the 
