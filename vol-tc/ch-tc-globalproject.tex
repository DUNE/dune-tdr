...
In carrying out these responsibilities, the \dword{ipd} receives support from the
 \dword{fnal} \dword{sdsd}. 
The head of the \dword{sdsd} works closely with \dword{surf} to
  ensure the appropriate infrastructure is in place for safe operations.
