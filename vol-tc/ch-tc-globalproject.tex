...
\begin{dunefigure}[Global project organization]{fig:DUNE_global}
  ...
  \includegraphics[width=0.99\textwidth]{HighLevel_OrgChart_v2}
\end{dunefigure}
...
\dword{fnal} director.  To ensure coordination 
...
pulled in from the \dword{lbnf} (LBNF), \dword{dune} (TCN), and 
...
\begin{dunefigure}[JPO organization chart]{fig:DUNE_jpo}
  ...
  \includegraphics[width=0.99\textwidth]{JPO_OrgChart}
\end{dunefigure}
...
organizations.  For example, the Project \dword{esh} manager 
...
builds and maintains a full \threed CAD model \fixme{Anne thinks 3D CAD is ok.} 
of everything in 
