...
cryogenic systems) that house the \dword{dune} \dword{fd}
...
Deputy Director for \dword{lbnf}.  The international \dword{dune}
...
international partners including the U.S. \dword{doe}.  The global
organization of the \dword{lbnf-dune}, which encompasses both project
...
element of the \dword{lbnf-dune} under the responsibility of 
...
team (co-spokespersons, \dword{tcoord}, and \dword{rcoord}).  The
\dword{efig} is responsible for steering the \dword{lbnf-dune} 
...
responsibility is passed to the \dword{fnal} Director.
