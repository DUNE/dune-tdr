...
installation of the \dword{lbnf-dune} deliverables and operates via the 
...
to plan and set the status of the resource-loaded schedule of activities required 
for  \dword{doe} contributions to \dword{lbnf} and \dword{dune}.
...
\dword{doe} activities.  Non-\dword{doe} activities will not be 
...
pieces within its scope.  Installation readiness reviews and \dwords{orr}, on the 
...
the upcoming installation at \dword{surf}. \dword{fnal}  
