...
appointed by and reports directly to the \dword{fnal} director.  To ensure
...
\dword{jpo} functions associated with its global project coordination role
...
global change control process is described in~\citedocdb{82}. %\dword{dune} DocDB-82.
...
integration and installation activities at \dword{surf} with their correct
...
will be maintained within the same \dword{p6} framework used to plan and
status the resource-loaded schedule of activities associated with the
USA contributions to \dword{lbnf} and \dword{dune}.  Activities that
fall under the responsibility of other international partners are
included and directly linked within the \dword{p6} schedule, but do not
...
formal \dword{evms} procedures required for USA project activities but rather
