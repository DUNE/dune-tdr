...
financial issues to the \dword{tb}, \dword{exb}, and \dword{rcoord} for resolution.
...
\end{enumerate}
These dates will be revisited when the \dword{tdr} is reviewed. The
...
\begin{itemize}
 ...
 \item TC requirements (cleanliness, \dword{apa} spacing, ...)?
\end{itemize}
