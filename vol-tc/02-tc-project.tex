...
\dword{protodune} we have established the teams, production lines, QA and QC
...
Volume~\ref{volnumberexec}:~\ref{voltitleexec}. A cost summary is
provided in Table~\ref{tab:cost_L1}.
\begin{dunetable}
  [\dword{dune} Project Cost at WBS level 1]
  {|p{0.05\linewidth}|p{0.15\linewidth}|p{0.2\linewidth}|p{0.2\linewidth}|p{0.2\linewidth}|}
  {tab:cost_L1}
