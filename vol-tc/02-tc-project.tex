...
\begin{dunetable}
  ...
  2.0 & Single-phase & &  & \\ \colhline
  3.0 & Dual-phase & & & \\ \colhline
\end{dunetable}
...
\begin{dunetable}
  [\dword{dune} requirements owned by \dword{exb}]
...
\dword{microboone}. Signiciant prototyping by both LBNE and LBNO has
furthered the value engineering process, leading to the key
\dword{protodune} detectors. Any significant departure from current
designs has to account for the success of \dword{protodune} and may
require testing in a second run of \dword{protodune}. This value
engineering process is executed at both the consortia and \dword{tc}
level.
...
since the ramp up of \dword{protodune} in summer 2016. The project plans to
