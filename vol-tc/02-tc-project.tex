...
\begin{dunetable}
  ...
  3   & PDS    & Light yield  & The light yield shall be sufficient for measuring event time of events with visible energy above 200 MeV.  Goal is to make possible a 10\% energy measurement for events with a visible energy of 10 MeV.  & >\SI{0.5}{pe/MeV} & >\SI{5}{pe/MeV}  \\ \colhline
  4   &        &   &   & &  \\ \colhline
\end{dunetable}
