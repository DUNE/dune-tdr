...
\dword{dune} has captured its risks in a risk registry in
DocDB-6443. This document includes tabs for the risks from each
consortia and \dword{tc}. It also includes a tab for the overall
...
\begin{dunefigure}[DUNE overall risk register]{fig:dune_risks1}
  ...
  \includegraphics[width=0.4\textwidth]{DUNE_Risks_v4a1}
\end{dunefigure}
\begin{dunefigure}[DUNE overall risk register]{fig:dune_risks2}
  {Second page of DUNE overall risk register.}
  \includegraphics[width=0.4\textwidth]{DUNE_Risks_v4a2}
\end{dunefigure}
