...
get some more information from David M.

\section{Underground Excavation and Infrastructure}
\label{sec:fdsp-coord-uderground-excavation}
In this section write about overall excavation in terms that affect the detector. Where
does the power, HVAC, cooling water, etc go? What are the limits on DUNE?
...
rooms for the \dword{dune} experiment.  Both rooms are in the west
...
and 500kVA available power.  \Dword{tc} will be responsible for
...
The \dword{dune} surface control room is provided as a responsibility
...
\begin{dunefigure}[Surface facilities room]{fig:dune-surf-facilities}
