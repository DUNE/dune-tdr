...
at \dword{surf}. The main campus is located at the 4850 foot level (\dword{4850l}), between
...
traverse the \dword{4850l} to the underground spaces.  The brakes, drive,
...
aligned with the \dword{4850l} of \dword{surf} with the cryostats resting
...
main caverns will be connected via a series of drifts at the \dword{4850l} as shown in
...
\begin{dunefigure}[\dshort{dune} cryostat]{fig:dune-full_assmebly}
  ...
  \includegraphics[width=0.85\textwidth]{graphics/LBNF_full_assembly}
\end{dunefigure}
...
\dword{lar} circulation pumps, all services are at the \dword{4850l} to
...
\begin{dunefigure}[Underground fire zones]{fig:lbnf-fire}
 ...
 \includegraphics[width=0.85\textwidth]{graphics/lbnf_fire}
\end{dunefigure}
...
\begin{dunefigure}[\dshort{dune} cryostat]{fig:dune-cryostat}
  ...
  \includegraphics[width=0.85\textwidth]{graphics/cryostat}
\end{dunefigure}
...
\begin{dunefigure}[Cryogenics system]{fig:dune-cryogenics}
  ...
  \includegraphics[width=0.85\textwidth]{graphics/LBNF_PFD_180909}
\end{dunefigure}
...
\begin{dunefigure}[North elevation view of detector]{fig:detector_ew_elevation}
  ...
  \includegraphics[width=0.75\textwidth]{graphics/LBNF-Cryostat-South_Elevation_in_Cavern_c}
\end{dunefigure}
...
\begin{dunefigure}[West elevation view of detector]{fig:detector_ns_elevation}
  ...
  \includegraphics[width=0.9\textwidth]{graphics/LBNF-Cryostat-West_Elevation_in_Cavern_c_with_Dimensions}
\end{dunefigure}
...
\begin{dunefigure}[Elevation view of top of cryostat]{fig:detector_mezzanines}
  ...
  \includegraphics[width=0.85\textwidth]{graphics/LBNF-Cryostat-West_Elevation-Cryo_c_with_Dimensions}
\end{dunefigure}
...
\begin{dunefigure}[Overall \dshort{dune} grounding structure]{fig:dune-grounding}
  ...
  \includegraphics[width=0.85\textwidth]{graphics/SURF_Grounding}
\end{dunefigure}
...
\begin{enumerate}
 \item Cavern ground consisting of overlapping welded wire mesh
   ...
   crown areas above the \dword{4850l} in the north and south detector
...
\begin{enumerate}
 \item spans the full length of the cavern from the west end access
   ...
   entrance;
 \item spans the full width of the cavern from the \dword{4850l} sill
...
\begin{dunefigure}[Simplified detector grounding]{fig:dune-grounding_figure}
  ...
  \includegraphics[width=0.5\textwidth]{graphics/Simplified_Grounding_Figure2}
\end{dunefigure}
...
\begin{dunefigure}[Detector grounding schematic]{fig:dune-grounding_scheme}
  ...
  \includegraphics[width=0.99\textheight,angle=90]{graphics/DUNE_FD_GNDing_diagram_revH1}
\end{dunefigure}
...
{\dword{dune} estimated power consumption.}
  \includegraphics[width=0.8\textwidth]{graphics/DUNE_PowerTable_v1}
\end{dunefigure}
...
run between the surface and the \dword{4850l}.  A total of 96 fiber
...
\begin{dunefigure}[Detector fiber path]{fig:dune-fiber_path}
  ...
  \includegraphics[width=0.95\textwidth]{graphics/Fiber_path}
\end{dunefigure}

The redundant fiber cable runs of 96 fiber pairs are received in
existing communications enclosures at the \dword{4850l} entrances of the Ross
...
\begin{dunefigure}[\dshort{daq} and control room in CUC]{fig:dune-cuc}
  ...
  \includegraphics[width=0.85\textwidth]{graphics/Location_Underground_DAQ_Control_Rooms}
\end{dunefigure}
\begin{dunefigure}[\dshort{daq} and control room]{fig:dune-daq}
  {Underground \dword{daq} and control room layout.}
  \includegraphics[width=0.85\textwidth]{graphics/Preliminary_Layout_DAQ_Control_Rooms}
\end{dunefigure}
...
\begin{dunefigure}[\dshort{daq} room layout]{fig:dune-DAQ_layout}
  ...
  \includegraphics[width=0.85\textwidth]{graphics/Prop_DAQ_room_layout}
\end{dunefigure}
...
to the optical fibers running to the \dword{4850l} via the Ross and Yates
...
\begin{dunefigure}[Surface rooms layout]{fig:dune-surface_layout}
  ...
  \includegraphics[width=0.95\textwidth]{graphics/Surface_rooms_layout}
\end{dunefigure}
...
The \dword{ddss} will provide input to the \dword{4850l}
fire alarm system.  The \dword{4850l} fire alarm system will provide life
...
The \dword{4850l} fire alarm system is connected to the surface incident command vault in the
...
system as well as the \dword{4850l} fire alarm system.  The \dword{dune} slow
...
(2) protect equipment (\dword{ddss}),  and (3) and provide life safety (\dword{4850l} fire alarm system). Figure~\ref{fig:dune-DDSS} indicates how these systems
...
\begin{dunefigure}[Examples of \dshort{dune} detector safety system information flow]{fig:dune-DDSS}
  ...
  \includegraphics[width=0.85\textwidth]{graphics/DDSS_Block_Diagram}
\end{dunefigure}
...
\begin{enumerate}
 ...
 \item Smoke or a temperature/humidity increase above normal operating
   ...
   dedicated line will alert \dword{4850l} fire alarm system.
 \item A water leak detected near energized equipment in the \dword{daq}
   ...
   to the \dword{4850l} fire alarm system.
\end{enumerate}
