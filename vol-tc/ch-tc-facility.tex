...
the second detector will be built in the east side of the south cavern. This
...
\begin{dunefigure}[Detector fiber path]{fig:dune-fiber_path}
  ...
  \includegraphics[width=0.85\textwidth]{Fiber_path}
\end{dunefigure}
...
\begin{dunefigure}[\dword{daq} and Control Room in CUC]{fig:dune-cuc}
...
\end{dunefigure}
\begin{dunefigure}[\dword{daq} and Control Room]{fig:dune-daq}
