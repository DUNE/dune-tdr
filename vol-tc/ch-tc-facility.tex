...
The \dword{dune} detectors are located in the main underground campus at\dword{surf}. The main campus is located at the 4850 level between the Ross and Yates Shafts.  
...
\begin{dunefigure}[Underground campus]{fig:dune-underground}
  ...
  \includegraphics[width=0.85\textwidth]{Underground_campus_vertical.pdf}
\end{dunefigure}
...
\dword{tco} \SI{13.43}{\meter} high, \SI{2.68}{\meter}
...
Note: In this section write about overall excavation in terms that affect the detector. Where
...
\begin{dunefigure}[DAQ room layout]{fig:dune-DAQ_layout}
  ...
  \includegraphics[width=0.5\textwidth]{Prop_DAQ_room_layout.png}
\end{dunefigure}
...
\begin{dunefigure}[Surface rooms layout]{fig:dune-surface_layout}
  ...
  \includegraphics[width=0.5\textwidth]{Surface_rooms_layout.png}
\end{dunefigure}
