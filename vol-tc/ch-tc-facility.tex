...
facilities and services.  All of these services %needed for work at the surface and underground 
can be performed  in
a safe and productive manner, leading to safe and productive operation of the \dwords{detmodule}.
...
experiment will be run.  The \dword{dune} experiment will have a remote
...
Detector Caverns, not the CUC.  If \dword{daq} equipment need to be serviced,
an experienced and trained group of technicians will be able to work
with remote collaborators to address issues in the \dword{daq} room.
...
and dedicated 750~kVA transformer.  \dword{tc} will be responsible for
