...
\begin{dunefigure}[DUNE cryostat]{fig:dune-full_assmebly}
...
\begin{dunefigure}[DUNE cryostat]{fig:dune-cryostat}
...
\begin{dunefigure}[Overall DUNE grounding structure]{fig:dune-grounding}
...
35~W per APA and supplies have an efficiency of approximately
85\%. This adds up to about 400 Watts per APA, or a total load of 60
kW per detector module. The APA wire-bias power supplies have a
...
237~kW. This higher estimate represents approximately 67\% of
our available power. The Dual Phase electronics estimate is
approximately 160~kW and also fits well within the planned maximum of
360~kW.
...
\begin{dunefigure}[DAQ room layout]{fig:dune-DAQ_layout}
  {Proposed rack layout in DAQ room.}
...
racks and a minimum of 50~kVA of power.  DAQ also requires connection
...
\begin{dunefigure}[DUNE detector safety system]{fig:dune-DDSS}
