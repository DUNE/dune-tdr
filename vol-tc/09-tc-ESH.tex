...
\dword{esh} Manual\footnote{\fnal ES\&H Manual is:
  http://esh.fnal.gov/xms/ESHQ-Manuals/feshm} (Fermilab Environmental and Safety Manual), which align with
...
\begin{dunetable}
  ...
  HA-7 (Mechanical) & HA-8 (Cryo/\dword{odh}) & HA-9 (Confined Space)   \\ \toprowrule
...
and 11000 series of chapters in the Fermilab Environmental and Safety Manual.  The environmental
...
the lockout/tagout following the Fermilab Enviornmental and Safey Manual
...
Fermilab Environmental and Safety Manual 9000 series chapters. Equipment procured from outside vendors or
...
electrical equipment inspection policies outlined in Fermilab Environmental and Safety Manual 9110,
...
noise levels that might exceed the \fnal noise action levels. Fermilab Environmental and Safety Manual
...
documentation, \dword{odh}  analysis documentation, and the equipment before
...
to comply with applicable Fermilab Environmental and Safety Manual 5000 series chapters as well as ASME and
American National Standards Institute (ANSI) standards.

\fnal has developed and successfully deployed \dword{odh} monitoring systems throughout the laboratory to support its current cryogenic operations. The systems provide both local and remote alarms when atmospheres contain less than 19.5\% oxygen by volume.

\fnal has a mature training program to address cryogenic safety
hazards. Key program elements include \dword{odh} training, pressurized gas
...
The \fnal confined space program is outlined in Fermilab Environmental and Safety Manual Chapter 4230,
...
The industrial hygiene program, detailed in the Fermilab Environmental and Safety Manual 4000 series
...
are contained in the Fermilab Environmental and Safety Manual 8000 and 10000 series chapters,
...
accordance with \fnal Fermilab Environmental and Safety Manual chapter 4260.)  Establishing the laser controlled area
...
programs documented in the Fermilab Environmental and Safety Manual 10000 series chapters.  The
...
activity and that any issues are appropriately addressed. The operational readiness clearance
process will document these reviews, covering the necessary controls
and management approval to proceed.

Typically, the operational readiness clearance process evaluates the scope of the proposed
...
Chapters 2060 in Fermilab Environmental and Safety Manual.
...
process, detailed in Fermilab Environmental and Safety Manual Chapter 2110, to establish code equivalency
