...
\dword{doe} Workers Safety and Health Program, Title
...
As the \dword{dune} design matures, the HAR will be updated to ensure that all
...
851 and \dword{doe} Order 420.2C, Safety of Accelerator Facilities.  Table 1
summarizes these hazards.  The sections following the table describe
the hazards, which are most applicable to \dword{dune} activities, in more
...
The probability of a fire at \dword{lbnf}/\dword{dune} is very low, similar to that of
