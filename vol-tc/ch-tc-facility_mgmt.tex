...
\begin{dunefigure}[View of the cleanroom for module \#1 showing the shuttle beam system]{fig:ashriver2}
  {View of the cleanroom for the \dword{spmod} \#1 showing the
    shuttle beam system}
