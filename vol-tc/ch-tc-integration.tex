...
will pass \dwords{orr} as discussed in Chapter~\ref{vl:tc-review}.  
Review by \dword{tc} will include
...
adherence to the electrical design rules in the \dword{feshm}.
