...
\begin{dunefigure}[APAs active area gap in cold state]{fig:dune-apa_aa_cold} 
    {\dword{spmod} gap in active areas between adjacent \dword{apa}s in the cold state. Dashed line warm sate, dots cold state.}
...
\begin{enumerate}
 ...
 \item Production: details responsibilities for component production and overall assembly, which is
   \fixme{typically?} shared among interfacing systems. %This section details who has what
   responsibilities.
