...
\caption{Risks for SP-FD-PDS \fixmehl{ref \texttt{tab:risks:SP-FD-PDS}}} \\
\rowcolor{dunesky}
...
RT-DP-PDS-010 & Damage of optical fibers during installation & Fibers will be the last \dual \dword{pds} item to be installed. Detailed documentation for all \dual \dwod{pds} installation tasks.   & L & L & L \\  \colhline
